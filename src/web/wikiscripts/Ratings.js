/* jshint -W004 */ // allow redifinition of vars
...
addOnloadHook(function () {
    ...
    console.log("Ratings initialising");
    //if ($.inArray("Spiele", wgCategories) > -1) {
    if (true) {
        var pageName = 'Ratings:' + wgPageName;
        disableEdit = false;
        var symbolInactive = new Image();
        symbolInactive.src = 'http://static1.wikia.nocookie.net/sonicwiki/de/images/9/91/SonicGamesRatingInactive.png';
        var symbolActive = new Image();
        symbolActive.src = 'http://static4.wikia.nocookie.net/sonicwiki/de/images/9/95/SonicGamesRatingActive.png';
...
function submitReview(reviewPageName, reviewRating, userIP, rating) {
    ...
    console.log(reviewPageName);
    //console.log("submitReview " + reviewPageName + " " + reviewRating + " " + userIP + " " + rating);
    disableEdit = true;
    setTimeout(function () {
        disableEdit = false;
    }, 500);
    callAPI({
        ...
        if (page.missing == "") {
            console.log("page.missing is empty");
            ...
            console.log("page.missing is not empty");
...
function onReviewReceived(rawData, isNew){
    
}

function fetchRatingData(cb) {
    callAPI({
        'action': 'query',
        'prop': 'info|revisions',
        'intoken': 'edit',
...
function getReview(reviewPageName, userIP) {
    ...
    console.log("getReview" + reviewPageName + " " + userIP);
    callAPI({
        'action': 'query',
        'prop': 'info|revisions',
        'intoken': 'edit',
        ...
        console.log("Review query recieved");
        var pages = response.query.pages;
        var page = null;
