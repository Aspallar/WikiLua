(function ($) {
    ...
    if (document.getElementById('mdw-cardname-span') === null)
        return;
    ...
    $('#mdw-cardname-span').html('<input type="text" id="mdw-cardname" />');
    $('#mdw-amount-spinner-span').html('<input type="number" id="mdw-amount-spinner" size="3" />');

    mw.loader.using('jquery.ui.autocomplete', function () {
        $('#mdw-cardname').autocomplete({
            source: cardnames
        });
        $('mdw-amount-spinner').spinner();
    });
