...
These rules are effective as of July 13, 2018.
...
103.4c In a multiplayer game and in any Brawl game, the first time a player takes a mulligan, they draw a new hand of as many cards they as had before. Subsequent hands decrease by one card as normal.
...
205.3j Planeswalkers have their own unique set of subtypes; these subtypes are called planeswalker types. The planeswalker types are Ajani, Angrath, Arlinn, Ashiok, Bolas, Chandra, Dack, Daretti, Domri, Dovin, Elspeth, Freyalise, Garruk, Gideon, Huatli, Jace, Jaya, Karn, Kaya, Kiora, Koth, Liliana, Nahiri, Narset, Nissa, Nixilis, Ral, Rowan, Saheeli, Samut, Sarkhan, Sorin, Tamiyo, Teferi, Tezzeret, Tibalt, Ugin, Venser, Vivien, Vraska, Will, Xenagos, Yanggu, and Yanling.
...
206.3. Previously, a spell or ability that affected cards from a particular set checked for that set’s expansion symbol. These cards have received errata in the Oracle card reference to say they affect cards “with a name originally printed” in a particular set. See rule 700.7 for details.
...
700.7. Some cards refer to cards with a name originally printed in a particular set.
...
701.21a To “fateseal N” means to look at the top N cards of an opponent’s library, put any number of them on the bottom of that library in any order and the rest on top of that library in any order.
...
701.33e If a manifested permanent that’s represented by an instant or sorcery card would turn face up, its controller reveals it and leaves it face down. Abilities that trigger whenever a permanent is turned face up won’t trigger.

701.33f See rule 707, “Face-Down Spells and Permanents,” for more information.
...
Editing: Del Laugel (lead), Glenn Jones, Gregg Luben, Nat Moes, and Matt Tabak
