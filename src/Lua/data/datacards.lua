...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[You may cast nonland cards with cycling from your graveyard.<br/>
...
Rarities={"Uncommon"};
Text=[=[Choose one —<br/>
• Abrade deals 3 damage to target creature.<br/>
...
Rarity="Common";
Rarities={"Common"};
Text=[=[Exile target creature you control, then return that card to the battlefield under its owner's control.<br/>
Draw a card.]=];
...
Flavor=[=["On every plane, there are those who run toward danger."<br/>
—Gideon Jura]=];
CardNumber="HOU1";
Rulings=4;
MultiverseID=430690;
...
Flavor=[=["Kefnet taught us to turn obstacles into advantages."<br/>
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[Enchant creature or Vehicle<br/>
As long as enchanted permanent is a Vehicle, it's a creature in addition to its other types.<br/>
...
When Aether Chaser enters the battlefield, you get {{E}}{{E}} (two energy counters).<br/>
...
Types={"Creature"};
SubTypes={"Elf";"Artificer";"Druid";};
Rarity="Common";
Rarities={"Common"};
Text=[=[When Aether Herder enters the battlefield, you get {{E}}{{E}} (two energy counters).<br/>
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[When Aether Hub enters the battlefield, you get {{E}} (an energy counter).<br/>
{{Tap}}: Add {{C}}.<br/>
...
Rarities={"Common"};
Text=[=[Vigilance<br/>
When Aether Inspector enters the battlefield, you get {{E}}{{E}} (two energy counters).<br/>
...
Enchant creature or Vehicle<br/>
When Aether Meltdown enters the battlefield, you get {{E}}{{E}} (two energy counters).<br/>
...
When Aether Poisoner enters the battlefield, you get {{E}}{{E}} (two energy counters).<br/>
...
Rarities={"Common"};
Text=[=[Flying<br/>
When Aether Swooper enters the battlefield, you get {{E}}{{E}} (two energy counters).<br/>
...
Rarity="Common";
Rarities={"Common"};
Text=[=[When Aether Theorist enters the battlefield, you get {{E}}{{E}}{{E}} (three energy counters).<br/>
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[Whenever you cast a spell, you gain 1 life for each spell you've cast this turn.<br/>
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[Whenever Aethergeode Miner attacks, you get {{E}}{{E}} (two energy counters).<br/>
...
Rarities={"Rare"};
Text=[=[Flying<br/>
When Aethersphere Harvester enters the battlefield, you get {{E}}{{E}} (two energy counters).<br/>
Pay {{E}}: Aethersphere Harvester gains lifelink until end of turn.<br/>
...
Rarities={"Rare"};
Text=[=[Flying<br/>
At the beginning of your upkeep, you get {{E}}{{E}}{{E}} (three energy counters).<br/>
...
Rarities={"Rare"};
Text=[=[Flying<br/>
Whenever Aetherstorm Roc or another creature enters the battlefield under your control, you get {{E}} (an energy counter).<br/>
...
Rarities={"Common"};
Text=[=[Trample<br/>
When Aetherstream Leopard enters the battlefield, you get {{E}} (an energy counter).<br/>
...
Rarities={"Rare"};
Text=[=[Flying<br/>
When Aethertide Whale enters the battlefield, you get {{E}}{{E}}{{E}}{{E}}{{E}}{{E}} (six energy counters).<br/>
Pay {{E}}{{E}}{{E}}{{E}}: Return Aethertide Whale to its owner's hand.]=];
Flavor=[=["To survive up here, I've learned when to use my harpoon and when to just enjoy the view."<br/>
—Kadhu, skywhaler]=];
CardNumber="AER27";
Power="6";
Toughness="4";
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[When Aethertorch Renegade enters the battlefield, you get {{E}}{{E}}{{E}}{{E}} (four energy counters).<br/>
{{Tap}}, Pay {{E}}{{E}}: Aethertorch Renegade deals 1 damage to target creature.<br/>
...
Rarities={"Mythic Rare"};
Text=[=[Trample<br/>
Whenever Aetherwind Basker enters the battlefield or attacks, you get {{E}} (an energy counter) for each creature you control.<br/>
...
Rarity="Mythic Rare";
Rarities={"Mythic Rare"};
Text=[=[Whenever a permanent you control is put into a graveyard, you get {{E}} (an energy counter).<br/>
...
Flavor=[=["Hesitation breeds dissension. To be worthy of the next life, you must never look back."<br/>
...
MultiverseID=450255;
Sets={
{Set="W17";Rarity="Uncommon";CardNumber="7";Flavor=[=[Pray that it doesn't seek the safety of your lungs.]=];};
...
Rarity="Mythic Rare";
Rarities={"Mythic Rare"};
Text=[=[+2: Reveal the top three cards of your library. Put all nonland permanent cards revealed this way into your hand and the rest on the bottom of your library in any order.<br/>
−2: Exile target creature. Its controller gains life equal to its power.<br/>
...
Rarity="Mythic Rare";
Rarities={"Mythic Rare"};
Text=[=[+1: Put a +1/+1 counter on each of up to two target creatures.<br/>
−2: Return target creature card with converted mana cost 2 or less from your graveyard to the battlefield.<br/>
...
Rarity="Mythic Rare";
Rarities={"Mythic Rare"};
Text=[=[+2: Put two +1/+1 counters on up to one target creature.<br/>
...
Rarity="Mythic Rare";
Rarities={"Mythic Rare"};
Text=[=[+2: You gain 1 life for each creature you control.<br/>
−3: Creatures you control get +2/+2 until end of turn.<br/>
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[When Ajani's Aid enters the battlefield, you may search your library and/or graveyard for a card named Ajani, Valiant Protector, reveal it, and put it into your hand. If you search your library this way, shuffle it.<br/>
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[Put two +1/+1 counters on target creature.<br/>
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[Whenever a creature or planeswalker you control dies, you may sacrifice Ajani's Last Stand. If you do, create a 4/4 white Avatar creature token with flying.<br/>
...
Rarities={"Common"};
Text=[=[Choose one —<br/>
• Target creature you control gets +1/+2 until end of turn.<br/>
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[As Alpine Moon enters the battlefield, choose a nonbasic land card name.<br/>
...
Flavor=[=["A rare and fascinating phenomenon."<br/>
—Tamiyo]=];
CardNumber="M19128";
Rulings=3;
MultiverseID=447264;
...
Types={"Creature"};
SubTypes={"Zombie";"Crocodile";"Demon";};
Rarity="Rare";
Rarities={"Rare"};
Text=[=[Afflict 3 (Whenever this creature becomes blocked, defending player loses 3 life.)<br/>
Whenever an opponent casts a spell, put a -1/-1 counter on Ammit Eternal.<br/>
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[Whenever you become the target of a spell or ability an opponent controls, counter that spell or ability unless its controller pays {{1}}.<br/>
...
{{2}}{{W}}, {{Tap}}: Exile another target creature. Return that card to the battlefield under its owner's control at the beginning of the next end step.<br/>
{{2}}{{W}}, {{Tap}}, Exert Angel of Condemnation: Exile another target creature until Angel of Condemnation leaves the battlefield. (An exerted creature won't untap during your next untap step.)]=];
CardNumber="HOU3";
Power="3";
Toughness="3";
Rulings=10;
...
Rarity="Mythic Rare";
Rarities={"Mythic Rare"};
Text=[=[Flying, vigilance, lifelink<br/>
Fabricate 2 (When this creature enters the battlefield, put two +1/+1 counters on it or create two 1/1 colorless Servo artifact creature tokens.)<br/>
...
Rarities={"Mythic Rare"};
Text=[=[Flying<br/>
When Angel of Sanctions enters the battlefield, you may exile target nonland permanent an opponent controls until Angel of Sanctions leaves the battlefield.<br/>
...
Flavor=[=[The angels did not deceive. From the start, they were clear their allegiance was to the God-Pharaoh and to him alone.]=];
CardNumber="HOU4";
Power="4";
Toughness="4";
MultiverseID=430693;
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[Whenever one or more +1/+1 counters are put on a permanent you control, you may pay {{1}}. If you do, create a 1/1 colorless Servo artifact creature token.<br/>
...
Flavor=[=["The gods here may walk among the people, but they are not with them."<br/>
—Gideon Jura]=];
CardNumber="AKH2";
Rulings=6;
MultiverseID=426704;
...
Rarity="Common";
Rarities={"Common"};
Text=[=[Whenever a creature token enters the battlefield under your control, you gain 1 life.<br/>
...
Rarity="Mythic Rare";
Rarities={"Mythic Rare"};
Text=[=[Exile the top seven cards of your library. Until end of turn, you may cast nonland cards exiled this way.<br/>
If this spell was cast from your hand, add ten mana of any one color.]=];
Flavor=[=["As I desire, so it shall be."<br/>
—Nicol Bolas]=];
CardNumber="M19129";
Rulings=4;
MultiverseID=447265;
...
Rarities={"Rare"};
Text=[=[Flying<br/>
Apocalypse Demon's power and toughness are each equal to the number of cards in your graveyard.<br/>
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[Until end of turn, target creature gains trample and gets +X/+X, where X is the number of creatures you control.<br/>
]=];
CardNumber="HOU152a";
Rulings=10;
MultiverseID=430841;
...
Flavor=[=["I'd just let the monkey have it if I were you. You can make another, but the same can't be said of your fingers."<br/>
...
Rarities={"Mythic Rare"};
Text=[=[Flying, vigilance<br/>
Whenever a creature with defender enters the battlefield under your control, draw a card.<br/>
...
Rarities={"Rare"};
Text=[=[Flying<br/>
Whenever you cycle or discard another card, put a -1/-1 counter on each creature your opponents control.<br/>
Cycling {{2}} ({{2}}, Discard this card: Draw a card.)]=];
CardNumber="AKH78";
Power="5";
Toughness="4";
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[Whenever a land enters the battlefield under your control, you get {{E}} (an energy counter).<br/>
...
Flavor=[=["I'm not picky about what comes up, but the less decay, the better."<br/>
—Liliana Vess]=];
CardNumber="M19292";
Power="3";
Toughness="3";
...
Rarity="Mythic Rare";
Rarities={"Mythic Rare"};
Text=[=[At the beginning of your upkeep, put a time counter on As Foretold.<br/>
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[Creatures your opponents control enter the battlefield tapped.<br/>
...
Flavor=[=["The only question we need to ask is how best to fulfill the will of the God-Pharaoh."]=];
CardNumber="AKH5";
Power="2";
Toughness="1";
Rulings=4;
...
Rarities={"Uncommon"};
Text=[=[Flying, vigilance<br/>
Creature tokens you control have flying and vigilance.<br/>
...
Flavor=[=["Not all in our crop deserve the afterlife. We must leave the unworthy behind, Samut."<br/>
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[Whenever Ballista Charger attacks, it deals 1 damage to any target.<br/>
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[Banefire deals X damage to any target.<br/>
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[When Banewhip Punisher enters the battlefield, you may put a -1/-1 counter on target creature.<br/>
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[Return up to three target artifacts and/or creatures to their owners' hands.<br/>
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[Improvise (Your artifacts can help cast this spell. Each artifact you tap after you're done activating mana abilities pays for {{1}}.)<br/>
Barricade Breaker attacks each combat if able.]=];
Flavor=[=["The Consulate sought to crush us. Let's give them a taste of their own medicine."<br/>
...
Manacost="{{5}}";
cmc=5;
Type="Artifact Creature — Elephant";
Types={"Artifact";"Creature";};
SubTypes={"Elephant"};
Rarity="Common";
Rarities={"Common"};
...
Flavor=[=["This is bigger than you. All of you."<br/>
—Tezzeret]=];
CardNumber="AER53";
Rulings=11;
MultiverseID=423720;
...
cmc=2;
Colors={"Red"};
Type="Creature — Jackal Rogue";
Types={"Creature"};
SubTypes={"Jackal";"Rogue";};
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[You may exert Battlefield Scavenger as it attacks. (It won't untap during your next untap step.)<br/>
...
Rarity="Common";
Rarities={"Common"};
Text=[=[Search your library for a basic land card, put it onto the battlefield tapped, then shuffle your library.<br/>
Cycling {{2}} ({{2}}, Discard this card: Draw a card.)]=];
...
cmc=5;
Colors={"Green"};
Type="Creature — Jackal Archer";
Types={"Creature"};
SubTypes={"Jackal";"Archer";};
Rarity="Common";
Rarities={"Common"};
Text=[=[Vigilance, reach]=];
Flavor=[=["Remember, brother, the eyes are always vulnerable."<br/>
"I never forgot."]=];
CardNumber="HOU112";
Power="4";
Toughness="4";
...
Flavor=[=[It returns eager to share the feast of blood and gore with its ghoulish master.]=];
CardNumber="W1715";
Power="2";
Toughness="2";
MultiverseID=429904;
...
Rarity="Common";
Rarities={"Common"};
Text=[=[{{Tap}}: Target creature gains haste until end of turn.]=];
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[Blooming Marsh enters the battlefield tapped unless you control two or fewer other lands.<br/>
{{Tap}}: Add {{B}} or {{G}}.]=];
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[When Bomat Bazaar Barge enters the battlefield, draw a card.<br/>
Crew 3 (Tap any number of creatures you control with total power 3 or more: This Vehicle becomes an artifact creature until end of turn.)]=];
CardNumber="KLD198";
Power="5";
Toughness="5";
...
Rarities={"Rare"};
Text=[=[Haste<br/>
Whenever Bomat Courier attacks, exile the top card of your library face down. (You can't look at it.)<br/>
...
Rarity="Mythic Rare";
Rarities={"Mythic Rare"};
Text=[=[Menace, indestructible<br/>
Bontu the Glorified can't attack or block unless a creature died under your control this turn.<br/>
...
Flavor=[=[To the last, Bontu wanted only to be first among the God-Pharaoh's subjects.]=];
CardNumber="HOU60";
Rulings=2;
MultiverseID=430749;
};
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[Black creature spells you cast cost {{1}} less to cast.<br/>
Whenever you cast a creature spell, each opponent loses 1 life and you gain 1 life.]=];
Flavor=[=["The worthy shall strive for greatness. Supremacy in life leads to supremacy in the afterlife."<br/>
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[Botanical Sanctum enters the battlefield tapped unless you control two or fewer other lands.<br/>
{{Tap}}: Add {{G}} or {{U}}.]=];
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[When Bristling Hydra enters the battlefield, you get {{E}}{{E}}{{E}} (three energy counters).<br/>
...
Flavor=[=["Dissent? Your gods can't even begin to comprehend the dissent that's about to happen here!"<br/>
—Chandra Nalaar]=];
CardNumber="AKH123";
Rulings=1;
MultiverseID=426825;
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[Revolt — At the beginning of your end step, if a permanent you controlled left the battlefield this turn, put a unity counter on Call for Unity.<br/>
...
MultiverseID=447184;
Sets={
{Set="AKH";Rarity="Common";CardNumber="44";Flavor=[=["Let me try one of Kefnet's puzzles. This one was too easy."]=];};
{Set="XLN";Rarity="Common";CardNumber="47";Flavor=[=["Hold your fire, obviously."
—Captain Brandis Thorn]=];};
};
};
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[Enchant creature you don't control<br/>
...
Flavor=[=["At last, the infamous Pia Nalaar."<br/>
—Tezzeret]=];
CardNumber="KLD8";
Rulings=6;
MultiverseID=417581;
...
When Cartouche of Ambition enters the battlefield, you may put a -1/-1 counter on target creature.<br/>
...
Rarities={"Common"};
Text=[=[Enchant creature you control<br/>
When Cartouche of Knowledge enters the battlefield, draw a card.<br/>
Enchanted creature gets +1/+1 and has flying.]=];
...
Rarities={"Common"};
Text=[=[Enchant creature you control<br/>
When Cartouche of Solidarity enters the battlefield, create a 1/1 white Warrior creature token with vigilance.<br/>
...
Rarities={"Common"};
Text=[=[Enchant creature you control<br/>
When Cartouche of Strength enters the battlefield, you may have enchanted creature fight target creature an opponent controls. (Each deals damage equal to its power to the other.)<br/>
...
Rarities={"Common"};
Text=[=[Enchant creature you control<br/>
When Cartouche of Zeal enters the battlefield, target creature can't block this turn.<br/>
...
Rarities={"Uncommon"};
Text=[=[Flash<br/>
When Cast Out enters the battlefield, exile target nonland permanent an opponent controls until Cast Out leaves the battlefield.<br/>
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[Counter target spell unless its controller pays {{1}}.<br/>
Cycling {{U}} ({{U}}, Discard this card: Draw a card.)]=];
Flavor=[=["Why so many questions?"<br/>
...
Types={"Creature"};
SubTypes={"Naga";"Wizard";};
Rarity="Rare";
Rarities={"Rare"};
Text=[=[When Champion of Wits enters the battlefield, you may draw cards equal to its power. If you do, discard two cards.<br/>
...
Rarity="Mythic Rare";
Rarities={"Mythic Rare"};
Text=[=[+2: Chandra, Pyrogenius deals 2 damage to each opponent.<br/>
−3: Chandra, Pyrogenius deals 4 damage to target creature.<br/>
...
Rarity="Mythic Rare";
Rarities={"Mythic Rare"};
Text=[=[+1: Exile the top card of your library. You may cast that card. If you don't, Chandra, Torch of Defiance deals 2 damage to each opponent.<br/>
+1: Add {{R}}{{R}}.<br/>
−3: Chandra, Torch of Defiance deals 4 damage to target creature.<br/>
...
Flavor=[=["Fire? Is that your only trick, Chandra?"<br/>
—Nicol Bolas]=];
CardNumber="HOU86";
MultiverseID=430775;
};
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[{{4}}, {{Tap}}: Target opponent exiles cards from the top of their library until they exile an instant or sorcery card. You may cast that card without paying its mana cost. Then put the exiled cards that weren't cast this way on the bottom of that library in a random order.]=];
CardNumber="M19228";
Rulings=6;
MultiverseID=447365;
};
...
Rarities={"Mythic Rare"};
Text=[=[Flash<br/>
This spell can't be countered.<br/>
Flying<br/>
...
{{Tap}}: Add {{B}} or {{R}}.]=];
Flavor=[=["I do as I choose with what is mine. And it is all mine."<br/>
—Nicol Bolas]=];
CardNumber="M19248";
MultiverseID=447385;
Sets={
{Set="AKH";Rarity="Common";CardNumber="280";Flavor=[=[A mudflow swallowed the lowlands years ago. All that remains are a bottomless mire and an endless rain of ash.]=];};
{Set="HOU";Rarity="Common";CardNumber="209";Flavor=[=["I do as I choose with what is mine. And it is all mine."
—Nicol Bolas]=];};
{Set="RIX";Rarity="Common";CardNumber="205";Flavor=[=["Burn their fleet to the waterline, and sink whatever's left."
—Angrath]=];};
};
};
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[Return target creature card with converted mana cost 2 or less from your graveyard to the battlefield.<br/>
]=];
CardNumber="HOU150a";
Rulings=9;
MultiverseID=430839;
...
Flavor=[=[Duplication is neither thievery nor flattery. It is efficiency.]=];
CardNumber="AER145";
Power="2";
Toughness="3";
Rulings=5;
...
Rarity="Common";
Rarities={"Common"};
Text=[=[When Cogworker's Puzzleknot enters the battlefield, create a 1/1 colorless Servo artifact creature token.<br/>
...
{Set="RIX";Rarity="Common";CardNumber="125";Flavor=[=["Remember when it was the most terrifying thing you'd ever seen?"
...
Flavor=[=["Might doesn't just build empires. It protects them."<br/>
...
Rarity="Common";
Rarities={"Common"};
Flavor=[=["If it is bigger, you must be faster. If it is stronger, you must be sharper. Anything less, and you will never seize a place in our God-Pharaoh's perfect afterlife."<br/>
...
Flavor=[=[Never before have there been so many brilliant minds and wondrous inventions in one place. Denizens from every corner of Kaladesh will flock to the once-in-a-lifetime Inventors' Fair.]=];
CardNumber="KLD148";
MultiverseID=417721;
};
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[Put target spell or nonland permanent into its owner's library second from the top.<br/>
]=];
CardNumber="AKH211a";
Rulings=12;
MultiverseID=426913;
...
Flavor=[=["The fiercest loyalties are earned in battle."<br/>
—Gideon Jura]=];
CardNumber="AKH271";
Power="2";
Toughness="2";
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[Concealed Courtyard enters the battlefield tapped unless you control two or fewer other lands.<br/>
{{Tap}}: Add {{W}} or {{B}}.]=];
...
Flavor=[=["The workshops are silent. Our creations have been seized. They have killed what made us alive."<br/>
—Pia Nalaar]=];
CardNumber="AER11";
Rulings=6;
MultiverseID=423678;
...
Flavor=[=["It's like they planted another Bastion right in the middle of the harbor."<br/>
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[When Consulate Surveillance enters the battlefield, you get {{E}}{{E}}{{E}}{{E}} (four energy counters).<br/>
...
Rarity="Common";
Rarities={"Common"};
Text=[=[{{Tap}}: You get {{E}} (an energy counter).<br/>
{{Tap}}, Pay {{E}}{{E}}{{E}}: Consulate Turret deals 2 damage to target player or planeswalker.]=];
Flavor=[=["Our watchtowers are well positioned. Why don't we arm them?"<br/>
—Enforcer-Chief Ranaj]=];
CardNumber="AER147";
Rulings=6;
MultiverseID=423814;
};
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[When Consul's Shieldguard enters the battlefield, you get {{E}}{{E}} (two energy counters).<br/>
...
Rarities={"Common"};
Text=[=[Enchant creature<br/>
Enchanted creature gets +1/+3.<br/>
...
Rarity="Common";
Rarities={"Common"};
Text=[=[Counter target spell unless its controller pays {{1}} for each card in your graveyard.<br/>
Cycling {{2}} ({{2}}, Discard this card: Draw a card.)]=];
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[Lifelink (Damage dealt by this creature also causes you to gain that much life.)<br/>
Court Cleric gets +1/+1 as long as you control an Ajani planeswalker.]=];
Flavor=[=["The healers of Bant are second to none. I owe them a great deal for their tutelage."<br/>
—Ajani Goldmane]=];
CardNumber="M19283";
Power="1";
Toughness="1";
...
Flavor=[=["All buildings are subject to search. Resistance will be punished."<br/>
—Enforcer-Chief Ranaj]=];
CardNumber="AER148";
Power="2";
Toughness="2";
...
Rarity="Common";
Rarities={"Common"};
Text=[=[Creatures you control gain trample until end of turn. (A creature with trample can deal excess combat damage to the player or planeswalker it's attacking.)<br/>
Draw a card.]=];
CardNumber="M19133";
Rulings=2;
MultiverseID=447269;
Sets={
{Set="HOU";Rarity="Common";CardNumber="88";Flavor=[=["We have to get out of the city, Djeru. All of us! Gather as many as you can."
...
Rarity="Mythic Rare";
Rarities={"Mythic Rare"};
Text=[=[Other Horses you control have indestructible.<br/>
At the beginning of each end step, if you gained life this turn, create a 5/5 white Horse creature token.]=];
Flavor=[=["It is evidence that some pure corner of the world must still exist."<br/>
...
Flavor=[=["Everything in the trial has teeth. You will overcome them, or you will feed them."<br/>
—Rhonas, god of strength]=];
CardNumber="AKH162";
Power="5";
Toughness="4";
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[{{1}}, {{Tap}}: Exile target card from a graveyard.<br/>
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[Fabricate 2 (When this creature enters the battlefield, put two +1/+1 counters on it or create two 1/1 colorless Servo artifact creature tokens.)<br/>
...
Rarities={"Rare"};
Text=[=[Flying<br/>
Whenever you cycle or discard another card, scry 1.<br/>
Cycling {{U}} ({{U}}, Discard this card: Draw a card.)]=];
...
Rarities={"Common"};
Text=[=[Menace (This creature can't be blocked except by two or more creatures.)]=];
Flavor=[=["Look! That is why we must never waver. That is what awaits us if we fail."<br/>
—Djeru, initiate of Tah crop]=];
CardNumber="AKH85";
Power="3";
Toughness="2";
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[Cut deals 4 damage to target creature.<br/>
]=];
CardNumber="AKH223a";
Rulings=9;
MultiverseID=426925;
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[Equipped creature gets +2/+0 and has afflict 1. (Whenever it becomes blocked, defending player loses 1 life.)<br/>
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[At end of combat, if Daredevil Dragster attacked or blocked this combat, put a velocity counter on it. Then if it has two or more velocity counters on it, sacrifice it and draw two cards.<br/>
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[Each opponent sacrifices a creature or planeswalker, then discards a card. You return a creature or planeswalker card from your graveyard to your hand, then draw a card.<br/>
...
Flavor=[=["It came to rest upon the angel's arm, and then the weight of their gazes fell upon me."<br/>
—Aeronaut's journal]=];
CardNumber="AER14";
Power="3";
Toughness="3";
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[Deadlock Trap enters the battlefield tapped.<br/>
When Deadlock Trap enters the battlefield, you get {{E}}{{E}} (two energy counters).<br/>
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[When Decimator Beetle enters the battlefield, put a -1/-1 counter on target creature you control.<br/>
...
Flavor=[=["Eyes see only what is possible. A trained mind can explore the impossible."<br/>
...
Flavor=[=["If you think yourself a chief, then prove your might."<br/>
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[Whenever a creature enters the battlefield under your control, you get {{E}} (an energy counter).<br/>
{{4}}, {{Tap}}: Return target creature you control to its owner's hand.]=];
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[Deem Worthy deals 7 damage to target creature.<br/>
Cycling {{3}}{{R}} ({{3}}{{R}}, Discard this card: Draw a card.)<br/>
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[When Defiant Greatmaw enters the battlefield, put two -1/-1 counters on target creature you control.<br/>
...
Flavor=[=["With spy thopters all around, how can the consuls be so blind to Tezzeret's manipulations?"<br/>
—Gideon Jura]=];
CardNumber="AER17";
Rulings=2;
MultiverseID=423684;
...
MultiverseID=435293;
Sets={
{Set="KLD";Rarity="Common";CardNumber="113";Flavor=[=[Most came to Ghirapur for the Fair. Gremlins came for the feast.]=];};
};
};
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[Demolition Stomper can't be blocked by creatures with power 2 or less.<br/>
...
Rarities={"Mythic Rare"};
Text=[=[Flying<br/>
When Demon of Dark Schemes enters the battlefield, all other creatures get -2/-2 until end of turn.<br/>
Whenever another creature dies, you get {{E}} (an energy counter).<br/>
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[Other Dwarves you control get +1/+1.<br/>
Each Vehicle you control gets +1/+1 as long as it's a creature.<br/>
Whenever Depala, Pilot Exemplar becomes tapped, you may pay {{X}}. If you do, reveal the top X cards of your library, put all Dwarf and Vehicle cards from among them into your hand, then put the rest on the bottom of your library in a random order.<br/>
]=];
CardNumber="KLD178";
Power="3";
Toughness="3";
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[When Departed Deckhand becomes the target of a spell, sacrifice it.<br/>
Departed Deckhand can't be blocked except by Spirits.<br/>
{{3}}{{U}}: Another target creature you control can't be blocked this turn except by Spirits.<br/>
]=];
CardNumber="M1949";
Power="2";
Toughness="2";
...
Rarities={"Uncommon"};
Text=[=[Enchant creature<br/>
When Desert's Hold enters the battlefield, if you control a Desert or there is a Desert card in your graveyard, you gain 3 life.<br/>
...
Flavor=[=["The nature of this plane makes it almost too easy for me to command the dead."<br/>
—Liliana Vess]=];
CardNumber="AKH276";
Power="3";
Toughness="2";
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[Target creature gets +1/+0 and gains indestructible until end of turn.<br/>
]=];
CardNumber="AKH217a";
Rulings=9;
MultiverseID=426919;
...
Flavor=[=["I don't think they'll appreciate my . . . adjustments."<br/>
...
Rarities={"Rare"};
Text=[=[{{Tap}}: Add {{C}}.<br/>
{{1}}, {{Tap}}: Until end of turn, your opponents and creatures your opponents control with hexproof can be the targets of spells and abilities you control as though they didn't have hexproof.]=];
...
Flavor=[=["Show them. Show them how hot your fire can burn."<br/>
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[As Diamond Mare enters the battlefield, choose a color.<br/>
...
Flavor=[=["At least this one still has arms and legs. Well, most of its legs."<br/>
...
Flavor=[=["How easily your flames are quenched."<br/>
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[As an additional cost to cast this spell, return a permanent you control to its owner's hand.<br/>
Counter target spell.]=];
Flavor=[=["Baral took my family from me back then. I'd do anything to face him now."<br/>
—Chandra Nalaar]=];
CardNumber="KLD43";
MultiverseID=417616;
};
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[{{R}}, {{Tap}}, Discard a card: Draw a card.<br/>
{{2}}{{R}}, {{Tap}}, Sacrifice Dismissive Pyromancer: It deals 4 damage to target creature.]=];
...
Rarity="Common";
Rarities={"Common"};
Text=[=[Destroy target artifact.<br/>
Cycling {{G}} ({{G}}, Discard this card: Draw a card.)]=];
Flavor=[=["When all doubts have melted away, the worthy will meet the Hour of Eternity and earn a place at the God-Pharaoh's side."<br/>
...
MultiverseID=447187;
Sets={
{Set="DOM";Rarity="Common";CardNumber="52";Flavor=[=["Half your studies will be learning the laws of magic. The other half will be bending them."
...
MultiverseID=439662;
Sets={
{Set="W17";Rarity="Common";CardNumber="1";Flavor=[=["Guilty."]=];};
};
};
...
Rarities={"Rare"};
Text=[=[Vigilance<br/>
When Djeru, With Eyes Open enters the battlefield, you may search your library for a planeswalker card, reveal it, put it into your hand, then shuffle your library.<br/>
...
Rarity="Common";
Rarities={"Common"};
Text=[=[Tap up to two target creatures.<br/>
Cycling {{W}} ({{W}}, Discard this card: Draw a card.)]=];
Flavor=[=["I was promised an afterlife, not this. Samut was right. The God-Pharaoh lied."<br/>
—Djeru, former Tah-crop initiate]=];
CardNumber="HOU11";
MultiverseID=430700;
};
...
Rarity="Common";
Rarities={"Common"};
Text=[=[Untap target creature. Prevent all damage that would be dealt to it this turn.<br/>
Cycling {{2}} ({{2}}, Discard this card: Draw a card.)]=];
...
MultiverseID=447229;
Sets={
{Set="AKH";Rarity="Common";CardNumber="87";Flavor=[=[There is only one fate left to those banished from the God-Pharaoh's city.]=];};
};
};
...
Rarity="Mythic Rare";
Rarities={"Mythic Rare"};
Text=[=[+1: Until your next turn, up to one target creature gets -3/-0 and its activated abilities can't be activated.<br/>
−1: You gain 2 life and draw a card.<br/>
...
Rarities={"Uncommon"};
Text=[=[{{Tap}}: Add one mana of any color.<br/>
{{7}}, {{Tap}}, Sacrifice Draconic Disciple: Create a 5/5 red Dragon creature token with flying.]=];
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[Whenever a Dragon enters the battlefield under your control, put a gold counter on Dragon's Hoard.<br/>
{{Tap}}, Remove a gold counter from Dragon's Hoard: Draw a card.<br/>
...
Flavor=[=["If you want to truly test your survival skills, walk the Obelisk Path when the drakes are feeding."<br/>
...
Flavor=[=["Nobody asked you to butt in, Jace. But thanks."<br/>
—Chandra Nalaar]=];
CardNumber="KLD44";
MultiverseID=417617;
};
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[Dread Wanderer enters the battlefield tapped.<br/>
...
Rarities={"Rare"};
Text=[=[Menace<br/>
Whenever Dreamstealer deals combat damage to a player, that player discards that many cards.<br/>
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[Until end of turn, creatures you control gain trample and "Whenever this creature deals combat damage to a player, draw a card."<br/>
]=];
CardNumber="HOU157a";
Rulings=12;
MultiverseID=430846;
...
MultiverseID=447313;
Sets={
{Set="AER";Rarity="Common";CardNumber="106";Flavor=[=["The wild tangle of the Cowl provides sanctuary to life that watched the first buildings rise."]=];};
};
};
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[{{Tap}}: Look at the top card of your library. If it's a land card, you may reveal it and put it into your hand.]=];
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[Whenever a creature enters the battlefield under your control, you may pay {{1}}. If you do, put a +1/+1 counter on that creature.<br/>
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[Destroy all creatures with power 3 or greater.<br/>
]=];
CardNumber="AKH210a";
Rulings=9;
MultiverseID=426912;
...
Rarities={"Common"};
Text=[=[Enchant creature<br/>
Enchanted creature gets -6/-0.<br/>
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[Whenever you cast an instant or sorcery spell, you get {{E}}{{E}} (two energy counters).<br/>
{{Tap}}, Pay {{E}}{{E}}{{E}}{{E}}{{E}}: Dynavolt Tower deals 3 damage to any target.]=];
Flavor=[=["I like that Tezzeret. He has vision the other judges don't. He sees the potential in what we're making here."<br/>
—Faiz, inventor]=];
CardNumber="KLD208";
Rulings=7;
MultiverseID=417781;
...
Rarities={"Rare"};
Text=[=[Haste<br/>
When Earthshaker Khenra enters the battlefield, target creature with power less than or equal to Earthshaker Khenra's power can't block this turn.<br/>
...
Rarities={"Common"};
Text=[=[Flying<br/>
When Eddytrail Hawk enters the battlefield, you get {{E}}{{E}} (two energy counters).<br/>
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[{{1}}, {{Tap}}: Target creature can't attack this turn. Put a brick counter on Edifice of Authority.<br/>
{{1}}, {{Tap}}: Until your next turn, target creature can't attack or block and its activated abilities can't be activated. Activate this ability only if there are three or more brick counters on Edifice of Authority.]=];
CardNumber="AKH226";
Rulings=3;
MultiverseID=426928;
};
...
MultiverseID=447275;
Sets={
{Set="AKH";Rarity="Common";CardNumber="129";Flavor=[=["Some hid from the storm. I embraced it and learned its name."]=];};
};
};
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[When Electrostatic Pummeler enters the battlefield, you get {{E}}{{E}}{{E}} (three energy counters).<br/>
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[Elegant Edgecrafters can't be blocked by creatures with power 2 or less.<br/>
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[As an additional cost to cast this spell, sacrifice X creatures.<br/>
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[Other Elves you control get +1/+1.<br/>
{{4}}{{G}}{{G}}, {{Tap}}: Search your library for a card named Elvish Clancaller, put it onto the battlefield, then shuffle your library.]=];
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[Embraal Bruiser enters the battlefield tapped.<br/>
...
Rarity="Common";
Rarities={"Common"};
Text=[=[{{Tap}}, Sacrifice an artifact: Embraal Gear-Smasher deals 2 damage to each opponent.]=];
...
Rarities={"Uncommon"};
Text=[=[Choose one —<br/>
• Target creature gets +5/+5 and gains trample until end of turn.<br/>
...
MultiverseID=447352;
Sets={
{Set="AKH";Rarity="Uncommon";CardNumber="198";Flavor=[=[Many initiates believe it possesses secrets known only to Kefnet himself. Many have become meals trying to learn them.]=];};
};
};
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[Whenever an artifact or Artificer enters the battlefield under your control, you may pay {{1}}. If you do, you get {{E}}{{E}} (two energy counters).<br/>
...
MultiverseID=447190;
Sets={
{Set="AKH";Rarity="Common";CardNumber="52";Flavor=[=[Dependence on luck is anathema to Kefnet's rigorous studies. Those who hope to escape his maze by chance never succeed.]=];};
};
};
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[Afflict 2 (Whenever this creature becomes blocked, defending player loses 2 life.)<br/>
Whenever Eternal of Harsh Truths attacks and isn't blocked, draw a card.]=];
Flavor=[=["If creating the Eternals was Bolas's plan here, what is his plan for the Eternals?"<br/>
—Jace Beleren]=];
CardNumber="HOU34";
Power="1";
Toughness="3";
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[When Exemplar of Strength enters the battlefield, put three -1/-1 counters on target creature you control.<br/>
...
Rarity="Common";
Rarities={"Common"};
Text=[=[{{3}}, {{Tap}}, Sacrifice Explosive Apparatus: It deals 2 damage to any target.]=];
Flavor=[=["Souls are volatile things. When compressed and loaded into a handheld device, their destructive potential is quite impressive."<br/>
—Dierk, geistmage]=];
CardNumber="M19233";
MultiverseID=447370;
};
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[Whenever you get one or more {{E}} (energy counters), put a +1/+1 counter on target creature you control.<br/>
{{4}}, {{Tap}}: You get {{E}}.]=];
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[Return target spell to its owner's hand.<br/>
]=];
CardNumber="AKH221a";
Rulings=11;
MultiverseID=426923;
...
Flavor=[=["The more I see of this place, the less I want to."<br/>
—Chandra Nalaar]=];
CardNumber="AKH90";
Rulings=2;
MultiverseID=426792;
...
Rarity="Common";
Rarities={"Common"};
Flavor=[=["Each day there are new reports of homes along Getander Pass and Hofsaddel falling to vampires of a more savage nature. I've even heard tell that Anje Falkenrath has returned. Please send whatever help you can."<br/>
...
Rarity="Common";
Rarities={"Common"};
Text=[=[{{2}}, {{Tap}}: Tap target creature.]=];
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[Destroy target attacking or blocking creature.<br/>
]=];
CardNumber="HOU148a";
Rulings=9;
MultiverseID=430837;
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[Destroy target creature if it has converted mana cost 2 or less.<br/>
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[Fateful Showdown deals damage to any target equal to the number of cards in your hand. Discard all the cards in your hand, then draw that many cards.]=];
...
Rarities={"Uncommon"};
Text=[=[Flying<br/>
When Fell Specter enters the battlefield, target opponent discards a card.<br/>
...
Flavor=[=["Success is found where others fear to look."<br/>
...
Flavor=[=["The most harmonious designs are based on relationships found in nature."<br/>
...
Manacost="{{3}}";
cmc=3;
Type="Artifact Creature — Fox";
Types={"Artifact";"Creature";};
SubTypes={"Fox"};
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[When Filigree Familiar enters the battlefield, you gain 2 life.<br/>
When Filigree Familiar dies, draw a card.]=];
Flavor=[=["It's the must-have gift for everyone on your list. Get one for yourself, too!"<br/>
—Chammi, curio vendor]=];
CardNumber="KLD212";
Power="2";
Toughness="2";
...
Rarities={"Uncommon"};
Text=[=[Aftermath (Cast this spell only from your graveyard. Then exile it.)<br/>
As an additional cost to cast Finish, sacrifice a creature.<br/>
...
Rarity="Common";
Rarities={"Common"};
Text=[=[When Fireforger's Puzzleknot enters the battlefield, it deals 1 damage to any target.<br/>
...
Flavor=[=["Allow zealous flames to light your path and the glory you seek will be revealed."<br/>
—Hazoret, god of zeal]=];
CardNumber="AKH131";
Power="1";
Toughness="2";
...
When Fleetwheel Cruiser enters the battlefield, it becomes an artifact creature until end of turn.<br/>
Crew 2 (Tap any number of creatures you control with total power 2 or more: This Vehicle becomes an artifact creature until end of turn.)]=];
CardNumber="KLD214";
Power="5";
Toughness="3";
...
Rarity="Common";
Rarities={"Common"};
Text=[=[Return up to two target creatures to their owners' hands.<br/>
Cycling {{2}} ({{2}}, Discard this card: Draw a card.)]=];
Flavor=[=["It usually appears placid, but don't be fooled. The Luxa River is a snake, and it can swallow you whole."<br/>
—Neponem, vizier of Kefnet]=];
CardNumber="AKH53";
MultiverseID=426755;
};
...
{Name="Forest";
SetCode="M19";
Allsets={"M19";"KLD";"AKH";"HOU";"XLN";"RIX";"DOM";};
...
MultiverseID=447415;
Sets={
{Set="KLD";Rarity="Basic Land";CardNumber="262";};
...
Rarity="Common";
Rarities={"Common"};
Text=[=[Exile target artifact or enchantment.<br/>
Cycling {{2}} ({{2}}, Discard this card: Draw a card.)]=];
...
{{Tap}}: Add {{W}} or {{B}}.]=];
Flavor=[=["Prayers will curdle on the tongue and be heard by rotting ears."<br/>
—Minaldra, the Vizag Atum]=];
CardNumber="M19250";
MultiverseID=447387;
Sets={
{Set="AKH";Rarity="Common";CardNumber="281";Flavor=[=["Prayers will curdle on the tongue and be heard by rotting ears."
—Minaldra, the Vizag Atum]=];};
...
• Return target artifact card from your graveyard to your hand.<br/>
...
MultiverseID=447388;
Sets={
{Set="AKH";Rarity="Common";CardNumber="279";Flavor=[=[On Amonkhet, death is an ever-present part of life.]=];};
{Set="RIX";Rarity="Uncommon";CardNumber="188";Flavor=[=[The stench of rotting meat lures flies, goblins, and young raptors.]=];};
};
};
...
Flavor=[=["They never tire, they never complain, and they never ask questions. Build more."<br/>
...
Flavor=[=["My creations still can't match the dive speed of those floppy-winged mammals. Maybe I should enter one of them in the Fair."<br/>
—Viprikti, thopterist]=];
CardNumber="KLD82";
Power="2";
Toughness="1";
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[At the beginning of your upkeep, you gain 1 life.<br/>
...
Flavor=[=["Too much friction on your bearings, your countersinking is inconsistent, and there are lines in your casting. Dispose of it, and begin again."<br/>
—Dovin Baan]=];
CardNumber="KLD14";
Rulings=2;
MultiverseID=417587;
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[Fretwork Colony can't block.<br/>
...
Flavor=[=["Ghirapur's gremlin population poses a threat to the infrastructure of the fairgrounds. Threats must be eliminated."<br/>
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[Furious Reprisal deals 2 damage to each of two targets.]=];
Flavor=[=["Now that's the Chandra I've been waiting to see."<br/>
—Liliana Vess]=];
CardNumber="KLD115";
Rulings=1;
MultiverseID=417688;
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[Return target tapped creature to its owner's hand.<br/>
Draw a card.]=];
...
Flavor=[=["Do not mistake a quiet rampart for one that is unguarded. Some things stir only when they need to."<br/>
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[Whenever a nontoken creature you control dies, you gain 1 life. Then you may draw a card. If you do, discard a card.<br/>
{{2}}, {{Tap}}, Sacrifice Gate to the Afterlife: Search your graveyard, hand, and/or library for a card named God-Pharaoh's Gift and put it onto the battlefield. If you search your library this way, shuffle it. Activate this ability only if there are six or more creature cards in your graveyard.]=];
CardNumber="AKH228";
Rulings=2;
MultiverseID=426930;
};
...
Rarity="Common";
Rarities={"Common"};
Text=[=[This spell costs {{1}} less to cast for each artifact you control.<br/>
...
MultiverseID=447318;
Sets={
{Set="KLD";Rarity="Uncommon";CardNumber="156";Flavor=[=[Fairgoers were delighted to find that even outside the fairgrounds, Ghirapur was a city of wonders.]=];};
};
};
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[Each player may play an additional land on each of their turns.<br/>
...
Flavor=[=["After everything I've survived, it's hard to be frightened by anything anymore."<br/>
—Vivien Reid]=];
CardNumber="M19183";
Power="2";
Toughness="4";
...
MultiverseID=447319;
Sets={
{Set="AKH";Rarity="Common";CardNumber="166";Flavor=[=[The Broken Lands are littered with the remnants of civilizations long dead and infested by terrors very much alive.]=];};
};
};
...
Rarity="Mythic Rare";
Rarities={"Mythic Rare"};
Text=[=[+1: Until your next turn, prevent all damage target permanent would deal.<br/>
0: Until end of turn, Gideon of the Trials becomes a 4/4 Human Soldier creature with indestructible that's still a planeswalker. Prevent all damage that would be dealt to him this turn.<br/>
...
Rarity="Mythic Rare";
Rarities={"Mythic Rare"};
Text=[=[+2: Untap all creatures you control. Those creatures get +1/+1 until end of turn.<br/>
0: Until end of turn, Gideon, Martial Paragon becomes a 5/5 Human Soldier creature with indestructible that's still a planeswalker. Prevent all damage that would be dealt to him this turn.<br/>
...
Flavor=[=["Gideon, how easy it must be to play the protector when you think yourself untouchable. How wrong you are."<br/>
—Nicol Bolas]=];
CardNumber="HOU13";
MultiverseID=430702;
};
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[As Gideon's Intervention enters the battlefield, choose a card name.<br/>
Your opponents can't cast spells with the chosen name.<br/>
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[When Gideon's Resolve enters the battlefield, you may search your library and/or graveyard for a card named Gideon, Martial Paragon, reveal it, and put it into your hand. If you search your library this way, shuffle it.<br/>
...
MultiverseID=447320;
Sets={
{Set="AKH";Rarity="Common";CardNumber="167";};
};
};
...
Rarity="Rare";
Rarities={"Rare"};
Flavor=[=["Each tooth is the length of a horse, and new ones grow in every sixteen days. Let's get a closer look!"<br/>
—Vivien Reid]=];
CardNumber="M19185";
Power="10";
Toughness="10";
...
Flavor=[=[The plating of its horns is a token of honor from Hazoret, who favors creatures with great hearts.]=];
CardNumber="HOU94";
Power="4";
Toughness="4";
Rulings=2;
...
Rarity="Common";
Rarities={"Common"};
Text=[=[When Glassblower's Puzzleknot enters the battlefield, scry 2, then you get {{E}}{{E}}. (You get two energy counters. To scry 2, look at the top two cards of your library, then put any number of them on the bottom of your library and the rest on top in any order.)<br/>
...
Rarities={"Rare"};
Text=[=[Menace<br/>
Whenever Glint-Sleeve Siphoner enters the battlefield or attacks, you get {{E}} (an energy counter).<br/>
...
Rarity="Common";
Rarities={"Common"};
Flavor=[=["There's no contract to sign, no oath to swear. The enlistment procedure is to unsheathe your sword and point it at the enemy."]=];
CardNumber="W172";
Power="2";
Toughness="2";
MultiverseID=429891;
...
Flavor=[=["Fly as an arrow through the trials, and never waver in your course."<br/>
...
Rarities={"Rare"};
Text=[=[Flying<br/>
Whenever Glyph Keeper becomes the target of a spell or ability for the first time each turn, counter that spell or ability.<br/>
...
Rarity="Common";
Rarities={"Common"};
Text=[=[{{Tap}}: Target creature gains haste until end of turn. (It can attack and {{Tap}} this turn.)]=];
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[Other Goblins you control get +1/+1.<br/>
...
Rarity="Mythic Rare";
Rarities={"Mythic Rare"};
Text=[=[Whenever Gonti's Aether Heart or another artifact enters the battlefield under your control, you get {{E}}{{E}} (two energy counters).<br/>
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[Whenever you lose life for the first time each turn, you get {{E}}. (You get an energy counter. Damage causes loss of life.)<br/>
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[Creature spells you cast with power 4 or greater cost {{2}} less to cast.<br/>
...
Text=[=[Menace<br/>
Cycling {{2}} ({{2}}, Discard this card: Draw a card.)]=];
Flavor=[=["That one's not mine. Run!"<br/>
—Nissa Revane]=];
CardNumber="HOU95";
Power="5";
Toughness="4";
...
MultiverseID=450259;
Sets={
{Set="RIX";Rarity="Common";CardNumber="74";Flavor=[=["I can hear the plunder calling. It asks for me by name."]=];};
};
};
...
MultiverseID=447234;
Sets={
{Set="AKH";Rarity="Uncommon";CardNumber="93";Flavor=[=[In Amonkhet's ever-shifting sands, nothing stays buried for long.]=];};
};
};
...
Flavor=[=["Rise and shine, my dears. We have work to do."<br/>
...
Rarity="Common";
Rarities={"Common"};
Text=[=[Greater Sandwurm can't be blocked by creatures with power 2 or less.<br/>
Cycling {{2}} ({{2}}, Discard this card: Draw a card.)]=];
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[Enchant artifact<br/>
At the beginning of your end step, Gremlin Infestation deals 2 damage to enchanted artifact's controller.<br/>
...
Flavor=[=["As a child I saw something walking in the distance, far beyond the Hekma—shadow-dark, and taller than the gods. Even now, it passes through my dreams."<br/>
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[Put a -1/-1 counter on each of up to two target creatures.<br/>
]=];
CardNumber="HOU155a";
Rulings=10;
MultiverseID=430844;
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[Whenever Hapatra, Vizier of Poisons deals combat damage to a player, you may put a -1/-1 counter on target creature.<br/>
...
Flavor=[=["If you fear poisons, it is because you are ignorant of them."<br/>
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[Target opponent reveals their hand. You choose a creature card from it. That player discards that card. Scry 1.]=];
Flavor=[=["If you've done nothing wrong, you have nothing to fear."<br/>
—Enforcer-Chief Ranaj]=];
CardNumber="KLD85";
Rulings=1;
MultiverseID=417658;
...
Rarity="Common";
Rarities={"Common"};
Text=[=[Prevent all combat damage that would be dealt this turn.<br/>
...
Rarity="Mythic Rare";
Rarities={"Mythic Rare"};
Text=[=[Indestructible, haste<br/>
Hazoret the Fervent can't attack or block unless you have one or fewer cards in hand.<br/>
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[Red creature spells you cast cost {{1}} less to cast.<br/>
Whenever you cast a creature spell, you may discard a card. If you do, draw a card.]=];
Flavor=[=["The worthy shall rush to the God-Pharaoh's side with relentless zeal, rising to overcome every obstacle."<br/>
—Monument inscription]=];
CardNumber="AKH229";
Rulings=4;
MultiverseID=426931;
...
Rarities={"Mythic Rare"};
Text=[=[Flying, vigilance<br/>
Crew 3 (Tap any number of creatures you control with total power 3 or more: This Vehicle becomes an artifact creature until end of turn.)<br/>
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[Heaven deals X damage to each creature with flying.<br/>
]=];
CardNumber="AKH224a";
Rulings=9;
MultiverseID=426926;
...
Text=[=[Improvise (Your artifacts can help cast this spell. Each artifact you tap after you're done activating mana abilities pays for {{1}}.)<br/>
Flying<br/>
At the beginning of your end step, each opponent discards a card.<br/>
...
Flavor=[=["Wherever the strong would harm the weak, I will be there."<br/>
—Ajani Goldmane]=];
CardNumber="AER109";
Rulings=1;
MultiverseID=423776;
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[Create two 1/1 white Soldier creature tokens. Until end of turn, creatures you control get +1/+1 and gain haste. (They can attack and {{Tap}} this turn.)]=];
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[Revolt — When Hidden Herbalists enters the battlefield, if a permanent you controlled left the battlefield this turn, add {{G}}{{G}}.]=];
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[Revolt — At the beginning of your end step, if a permanent you controlled left the battlefield this turn, create a 1/1 colorless Servo artifact creature token.<br/>
...
Flavor=[=["Bring down a stag and fix its horns upon Arel's head. She hears the wisdom of our ancestors."<br/>
...
MultiverseID=447389;
Sets={
{Set="AKH";Rarity="Common";CardNumber="282";Flavor=[=[With the fate of Innistrad uncertain, some seek solace in remote areas.]=];};
{Set="RIX";Rarity="Uncommon";CardNumber="189";Flavor=[=["A place like this makes me wonder if there's more to life than blood and treasure . . . Nah."
—Boyl Bucksalt, Storm Fleet swab]=];};
};
};
...
Flavor=[=["If nothing else, the Inventors' Fair taught us that we're only beginning to discover aether's true potential."<br/>
...
Rarities={"Common"};
Text=[=[Defender<br/>
When Hightide Hermit enters the battlefield, you get {{E}}{{E}}{{E}}{{E}} (four energy counters).<br/>
...
MultiverseID=435302;
Sets={
{Set="KLD";Rarity="Common";CardNumber="118";Flavor=[=["Whoa there. Easy. We're just going to take a little detour."]=];};
};
};
...
Flavor=[=["As a kid, I dreamed of flying on those wild drakes. They inspired me to build wings of my own."<br/>
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[{{1}}, {{Tap}}: Untap target land.<br/>
{{1}}, {{Tap}}, Exert Hope Tender: Untap two target lands. (An exerted creature won't untap during your next untap step.)]=];
...
Rarity="Common";
Rarities={"Common"};
Text=[=[Whenever you cycle or discard another card, Horror of the Broken Lands gets +2/+1 until end of turn.<br/>
...
Flavor=[=["Everything here exists or perishes at my whim. Including you, Gatewatch."<br/>
—Nicol Bolas]=];
CardNumber="HOU97";
Rulings=3;
MultiverseID=430786;
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[Hungering Hydra enters the battlefield with X +1/+1 counters on it.<br/>
Hungering Hydra can't be blocked by more than one creature.<br/>
...
MultiverseID=439790;
Sets={
{Set="KLD";Rarity="Common";CardNumber="158";Flavor=[=[Natural evolution is often at odds with industrial progress.]=];};
};
};
...
Rarity="Common";
Rarities={"Common"};
Text=[=[Enchant artifact or creature<br/>
Enchanted permanent doesn't untap during its controller's untap step.]=];
Flavor=[=["Slow the Consulate with whatever you've got!"<br/>
—Jasi Ganin, master siphoner]=];
CardNumber="AER35";
Rulings=1;
MultiverseID=423702;
};
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[Exile up to two target creatures you control, then return those cards to the battlefield under their owner's control.<br/>
Draw a card.]=];
Flavor=[=["When everything hangs on a single moment, be sure you choose the right moment."<br/>
—Jace Beleren]=];
CardNumber="AER36";
Rulings=5;
MultiverseID=423703;
...
Flavor=[=["No amount of strength can help you overcome my trial. You must be ready to forgo your body and favor your mind."<br/>
—Kefnet, god of knowledge]=];
CardNumber="AKH58";
Rulings=2;
MultiverseID=426760;
...
MultiverseID=426720;
Sets={
{Set="KLD";Rarity="Common";CardNumber="19";Flavor=[=[When Baral constructed his trap for Chandra, he did not account for the arrival of an enormous leonin wielding a twin-headed axe.]=];};
};
};
...
Rarity="Common";
Rarities={"Common"};
Text=[=[{{R}}, Sacrifice Implement of Combustion: It deals 1 damage to target player or planeswalker.<br/>
...
Rarity="Common";
Rarities={"Common"};
Text=[=[{{U}}, Sacrifice Implement of Examination: Draw a card.<br/>
...
Rarity="Common";
Rarities={"Common"};
Text=[=[{{G}}, Sacrifice Implement of Ferocity: Put a +1/+1 counter on target creature. Activate this ability only any time you could cast a sorcery.<br/>
...
Rarity="Common";
Rarities={"Common"};
Text=[=[{{W}}, Sacrifice Implement of Improvement: You gain 2 life.<br/>
...
Rarity="Common";
Rarities={"Common"};
Text=[=[{{B}}, Sacrifice Implement of Malice: Target player discards a card. Activate this ability only any time you could cast a sorcery.<br/>
...
Flavor=[=["A single grain of sand is insignificant, but a sandstorm can reduce pyramids to dust. Stand with your crop. Become the storm."<br/>
—Oketra, god of solidarity]=];
CardNumber="AKH19";
Rulings=1;
MultiverseID=426721;
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[As an additional cost to cast this spell, sacrifice an artifact.<br/>
...
Flavor=[=["When these intruders are gone, Zendikar will be my throne, my palace, my playground."]=];
CardNumber="M19102";
Rulings=2;
MultiverseID=447238;
};
...
Flavor=[=["I'd like to say that it's our pet, but the reverse may be closer to the truth."<br/>
...
• You may choose new targets for target spell.<br/>
• Copy target instant or sorcery spell. You may choose new targets for the copy.]=];
Flavor=[=["We meet again, pyromancer."<br/>
—Baral, Chief of Compliance]=];
CardNumber="KLD52";
Rulings=9;
MultiverseID=417625;
...
Flavor=[=["Day 31: I finally succeeded in my time reversal experiment!<br/>
"Day 30: I might have a problem here."<br/>
...
MultiverseID=447151;
Sets={
{Set="KLD";Rarity="Common";CardNumber="20";Flavor=[=[One dwarf on a build team ensures competence. All dwarves on the team ensures brilliance.]=];};
};
};
...
Flavor=[=["This is about more than aether or inventions. Tezzeret's schemes must be stopped!"<br/>
—Ajani Goldmane]=];
CardNumber="AER186";
MultiverseID=425693;
};
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[Inspiring Vantage enters the battlefield tapped unless you control two or fewer other lands.<br/>
{{Tap}}: Add {{R}} or {{W}}.]=];
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[Damage can't be prevented this turn. If a source you control would deal damage this turn, it deals double that damage instead.<br/>
]=];
CardNumber="AKH213a";
Rulings=12;
MultiverseID=426915;
...
Flavor=[=["Everyone starts off making garbage. If you finally make something halfway decent, it'll be the best day of your life."<br/>
—Nehra, inventor]=];
CardNumber="KLD120";
Power="1";
Toughness="2";
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[At the beginning of your upkeep, if you control three or more artifacts, you gain 1 life.<br/>
{{Tap}}: Add {{C}}.<br/>
{{4}}, {{Tap}}, Sacrifice Inventors' Fair: Search your library for an artifact card, reveal it, put it into your hand, then shuffle your library. Activate this ability only if you control three or more artifacts.]=];
CardNumber="KLD247";
Rulings=4;
MultiverseID=417820;
};
...
Rarity="Common";
Rarities={"Common"};
Text=[=[Equipped creature gets +1/+2.<br/>
Whenever an Artificer enters the battlefield under your control, you may attach Inventor's Goggles to it.<br/>
Equip {{2}} ({{2}}: Attach to target creature you control. Equip only as a sorcery.)]=];
CardNumber="KLD218";
Rulings=1;
MultiverseID=417791;
...
Rarities={"Uncommon"};
Text=[=[Choose one —<br/>
• Target creature gets +4/+0 and gains trample until end of turn.<br/>
...
MultiverseID=447152;
Sets={
{Set="DOM";Rarity="Common";CardNumber="22";Flavor=[=["Let go of all that harms you. Cast your burdens into the darkness, and build for the faithful a house of light."
...
MultiverseID=447403;
Sets={
{Set="KLD";Rarity="Basic Land";CardNumber="253";};
...
Flavor=[=["I had hoped for more from you, Jace. But I expected as much."<br/>
—Nicol Bolas]=];
CardNumber="HOU38";
MultiverseID=430727;
};
...
Types={"Creature"};
SubTypes={"Vedalken";"Soldier";};
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[When Janjeet Sentry enters the battlefield, you get {{E}}{{E}} (two energy counters).<br/>
...
Flavor=[=["Only those who give the dragons the respect they deserve may bear our title."]=];
CardNumber="M19297";
Power="2";
Toughness="2";
MultiverseID=450244;
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[Gain control of target creature or Vehicle until end of turn. Untap it. It gains haste until end of turn.<br/>
...
Rarity="Mythic Rare";
Rarities={"Mythic Rare"};
Text=[=[Flying, indestructible<br/>
Kefnet the Mindful can't attack or block unless you have seven or more cards in hand.<br/>
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[Blue creature spells you cast cost {{1}} less to cast.<br/>
...
Flavor=[=["The worthy shall cultivate a nimble mind to perceive the glorious wonders that await them."<br/>
—Monument inscription]=];
CardNumber="AKH231";
Rulings=5;
MultiverseID=426933;
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[{{Tap}}, Discard a card: Up to one target creature can't be blocked this turn.<br/>
...
Rarities={"Uncommon"};
Text=[=[Enchant creature<br/>
When Knightly Valor enters the battlefield, create a 2/2 white Knight creature token with vigilance. (Attacking doesn't cause it to tap.)<br/>
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[When Labyrinth Guardian becomes the target of a spell, sacrifice it.<br/>
...
Flavor=[=["They say Head Judge Tezzeret will be reviewing every invention at the Fair. I made sure to build something that will stand out."<br/>
...
Rarities={"Rare"};
Text=[=[Flying<br/>
Whenever another nontoken Dragon enters the battlefield under your control, create a 5/5 red Dragon creature token with flying.<br/>
...
Rarities={"Rare"};
Text=[=[Haste<br/>
When Lathnu Hellion enters the battlefield, you get {{E}}{{E}} (two energy counters).<br/>
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[Return any number of target permanents you own to your hand.<br/>
]=];
CardNumber="HOU153a";
Rulings=10;
MultiverseID=430842;
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[When Lena, Selfless Champion enters the battlefield, create a 1/1 white Soldier creature token for each nontoken creature you control.<br/>
...
Flavor=[=["If you believe the God-Pharaoh tests you, charge with me to prove yourself. If you believe he betrayed us all, join with me to fight for tomorrow!"<br/>
—Samut, former Tah-crop initiate]=];
CardNumber="HOU121";
Rulings=2;
MultiverseID=430810;
...
Flavor=[=["I do not ask you to be tame. I only ask you to be true."<br/>
...
Flavor=[=["Inspiration is found by looking outward."<br/>
...
Rarities={"Uncommon"};
Text=[=[This spell can't be countered.<br/>
Lightning Mare can't be blocked by blue creatures.<br/>
...
MultiverseID=447288;
Sets={
{Set="XLN";Rarity="Uncommon";CardNumber="149";Flavor=[=["Storm on the horizon, cap'n!"
...
Rarity="Mythic Rare";
Rarities={"Mythic Rare"};
Text=[=[+2: Put a -1/-1 counter on up to one target creature.<br/>
−3: Destroy target creature with a -1/-1 counter on it.<br/>
...
Rarity="Mythic Rare";
Rarities={"Mythic Rare"};
Text=[=[+1: Create a 2/2 black Zombie creature token. Put the top two cards of your library into your graveyard.<br/>
−3: Return target creature card from your graveyard to the battlefield. That creature is a black Zombie in addition to its other colors and types.<br/>
...
Rarity="Mythic Rare";
Rarities={"Mythic Rare"};
Text=[=[+1: Target player loses 2 life.<br/>
−1: Return target creature card from your graveyard to your hand.<br/>
...
Rarity="Mythic Rare";
Rarities={"Mythic Rare"};
Text=[=[+1: Put the top three cards of your library into your graveyard. If at least one of them is a Zombie card, each opponent loses 2 life and you gain 2 life.<br/>
−2: Target creature gets -X/-X until end of turn, where X is the number of Zombies you control.<br/>
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[When Liliana's Contract enters the battlefield, you draw four cards and you lose 4 life.<br/>
...
Flavor=[=["All the power you have gathered for yourself, Liliana, I can take away."<br/>
—Nicol Bolas]=];
CardNumber="HOU68";
MultiverseID=430757;
};
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[Zombies you control get +1/+1.<br/>
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[Target opponent discards a card.<br/>
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[Gain control of target creature until end of turn. Untap that creature. It gains haste until end of turn.<br/>
Cycling {{2}} ({{2}}, Discard this card: Draw a card.)]=];
Flavor=[=["When the time comes, only one of you will be honored by my spear."<br/>
—Hazoret, god of zeal]=];
CardNumber="AKH140";
MultiverseID=426842;
};
...
MultiverseID=450261;
Sets={
{Set="DOM";Rarity="Common";CardNumber="168";Flavor=[=[As patient and generous as life, as harsh and merciless as nature.]=];};
};
};
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[Whenever Longtusk Cub deals combat damage to a player, you get {{E}}{{E}} (two energy counters).<br/>
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[Other Zombies you control get +1/+1.<br/>
{{1}}{{B}}, {{Tap}}: All Zombies gain menace until end of turn.]=];
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[Choose a nonartifact, nonland card name. Search target player's graveyard, hand, and library for any number of cards with that name and exile them. That player shuffles their library, then draws a card for each card exiled from hand this way.]=];
Flavor=[=["That name shall not be spoken."<br/>
—Baral, Chief of Compliance]=];
CardNumber="KLD88";
MultiverseID=417661;
};
...
MultiverseID=447161;
Sets={
{Set="RIX";Rarity="Common";CardNumber="12";Flavor=[=["Your part in this fight is done, vampire. Get used to your thirst."]=];};
};
};
...
Rarity="Common";
Rarities={"Common"};
Text=[=[{{1}}, {{Tap}}: You gain 1 life. Put a brick counter on Luxa River Shrine.<br/>
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[{{4}}, {{Tap}}: Put a charge counter on Magistrate's Scepter.<br/>
...
Flavor=[=["Ashes can't be embalmed."<br/>
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[At the beginning of your upkeep, put a -1/-1 counter on Magmaroth.<br/>
...
Rarity="Mythic Rare";
Rarities={"Mythic Rare"};
Text=[=[Majestic Myriarch's power and toughness are each equal to twice the number of creatures you control.<br/>
...
Flavor=[=[Yesterday's marvels are today's antiques.]=];
CardNumber="KLD89";
Rulings=1;
MultiverseID=417662;
};
...
Rarities={"Common"};
Text=[=[Enchant artifact or creature<br/>
When Malfunction enters the battlefield, tap enchanted permanent.<br/>
Enchanted permanent doesn't untap during its controller's untap step.]=];
...
MultiverseID=447376;
Sets={
{Set="HOU";Rarity="Common";CardNumber="164";Flavor=[=["Though the afterlife, the city, and even the God-Pharaoh himself were one great deception, the ideals championed by the gods remain true."
—Djeru, former Tah-crop initiate]=];};
};
};
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[When Manglehorn enters the battlefield, you may destroy target artifact.<br/>
Artifacts your opponents control enter the battlefield tapped.]=];
Flavor=[=["Rely too much on your weapons and watch your dreams shatter in your hands."<br/>
—Rhonas, god of strength]=];
CardNumber="AKH175";
Power="2";
Toughness="2";
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[Fabricate 3 (When this creature enters the battlefield, put three +1/+1 counters on it or create three 1/1 colorless Servo artifact creature tokens.)<br/>
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[Servos and Thopters you control get +1/+1.<br/>
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[When Maulfist Doorbuster enters the battlefield, you get {{E}}{{E}} (two energy counters).<br/>
...
{Set="DOM";Rarity="Common";CardNumber="274";Flavor=[=["Everywhere you look, this world is healing from its wounds. Aren't you ready to do the same?"
—Jhoira, to Teferi]=];};
};
};
...
Rarity="Mythic Rare";
Rarities={"Mythic Rare"};
Text=[=[Enchant artifact you control<br/>
...
Flavor=[=["Give me eight walkers, I'll give you the city."<br/>
—Dovin Baan]=];
CardNumber="AER38";
Rulings=11;
MultiverseID=423705;
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[{{3}}{{U}}, {{Tap}}, Tap X untapped artifacts you control: Look at the top X cards of your library. Put one of them into your hand and the rest on the bottom of your library in any order.]=];
Flavor=[=["If you can build it, we can move it."<br/>
—Bes Tavani, Bomat merchant]=];
CardNumber="AER163";
Power="1";
Toughness="2";
...
Flavor=[=["My work here is complete. The people have done everything required of them."<br/>
—Nicol Bolas]=];
CardNumber="HOU71";
Power="2";
Toughness="2";
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[As Metallic Mimic enters the battlefield, choose a creature type.<br/>
Metallic Mimic is the chosen type in addition to its other types.<br/>
...
Flavor=[=["Too little, too late. The machine is in motion."<br/>
—Tezzeret]=];
CardNumber="AER39";
Rulings=8;
MultiverseID=423706;
...
Rarity="Mythic Rare";
Rarities={"Mythic Rare"};
Text=[=[Whenever you cast an instant or sorcery spell, create an X/X colorless Construct artifact creature token, where X is that spell's converted mana cost.<br/>
...
Rarity="Common";
Rarities={"Common"};
Text=[=[When Metalspinner's Puzzleknot enters the battlefield, you draw a card and you lose 1 life.<br/>
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[This spell costs {{X}} less to cast, where X is the total converted mana cost of noncreature artifacts you control.<br/>
...
Rarities={"Rare"};
Text=[=[Enchant creature<br/>
As Metamorphic Alteration enters the battlefield, choose a creature.<br/>
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[Other Aetherborn you control get +1/+1.<br/>
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[Midnight Oil enters the battlefield with seven hour counters on it.<br/>
At the beginning of your draw step, draw an additional card and remove two hour counters from Midnight Oil.<br/>
Your maximum hand size is equal to the number of hour counters on Midnight Oil.<br/>
...
Flavor=[=["I feel the presence of the God-Pharaoh in the Second Sun, and I rise upon its rays."]=];
CardNumber="M1928";
Rulings=1;
MultiverseID=447164;
Sets={
{Set="AKH";Rarity="Common";CardNumber="20";Flavor=[=["I feel the presence of the God-Pharaoh in the Second Sun, and I rise upon its rays."]=];};
};
};
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[{{2}}, {{Tap}}: Target player puts the top two cards of their library into their graveyard.]=];
...
MultiverseID=447245;
Sets={
{Set="KLD";Rarity="Common";CardNumber="93";Flavor=[=[Many an inventor has collapsed under the pressure to create a flawless design.]=];};
};
};
...
cmc=1;
Colors={"Blue"};
Type="Creature — Vedalken Advisor";
Types={"Creature"};
SubTypes={"Vedalken";"Advisor";};
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[When Minister of Inquiries enters the battlefield, you get {{E}}{{E}} (two energy counters).<br/>
...
Flavor=[=[Most mirrors show your reflection. Others show your potential.]=];
CardNumber="HOU165";
Rulings=8;
MultiverseID=430854;
};
...
Flavor=[=[Hospitality is of little concern to those who do not wish to be disturbed.]=];
CardNumber="M1962";
Power="1";
Toughness="1";
Rulings=3;
...
Flavor=[=[With matchless stealth, the River Heralds fought a running battle against enemy forces.]=];
CardNumber="M19310";
Power="1";
Toughness="1";
MultiverseID=450257;
Sets={
{Set="RIX";Rarity="Common";CardNumber="43";Flavor=[=[With matchless stealth, the River Heralds fought a running battle against the three enemy forces.]=];};
};
};
...
Rarity="Common";
Rarities={"Common"};
Text=[=[Whenever Mobile Garrison attacks, untap another target artifact or creature you control.<br/>
Crew 2 (Tap any number of creatures you control with total power 2 or more: This Vehicle becomes an artifact creature until end of turn.)]=];
CardNumber="AER165";
Power="3";
Toughness="4";
...
MultiverseID=447411;
Sets={
{Set="KLD";Rarity="Basic Land";CardNumber="259";};
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[Create a 3/3 green Hippo creature token.<br/>
]=];
CardNumber="AKH214a";
Rulings=9;
MultiverseID=426916;
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[When Multiform Wonder enters the battlefield, you get {{E}}{{E}}{{E}} (three energy counters).<br/>
Pay {{E}}: Multiform Wonder gains your choice of flying, vigilance, or lifelink until end of turn.<br/>
...
Flavor=[=["It appears some mummies have begun to observe a hierarchy all their own."<br/>
...
Flavor=[=["It is folly to believe your precious inventions will endure. All things return to the soil."<br/>
—Nirav, Tirahar elder]=];
CardNumber="AER118";
MultiverseID=423785;
};
...
Flavor=[=["And if you threaten me again, your shiny steel trousers will be sprouting daggerthorn vines."<br/>
—Iveta, rooftop runner]=];
CardNumber="M19190";
MultiverseID=447326;
Sets={
{Set="RIX";Rarity="Common";CardNumber="139";Flavor=[=["Better to let the sword go than to lose the arm with it."
—Captain Lannery Storm]=];};
};
};
...
MultiverseID=439701;
Sets={
{Set="AER";Rarity="Common";CardNumber="40";Flavor=[=["It is fascinating to see how the people of this plane replicate magical techniques without a natural gift. Also frustrating."
—Jace Beleren]=];};
};
};
...
Rarities={"Rare"};
Text=[=[First strike<br/>
Other Minotaurs you control have first strike.<br/>
As long as you have one or fewer cards in hand, Minotaurs you control get +2/+0.<br/>
...
Flavor=[=["They are small, but they always want more. Learn from them."<br/>
—Bontu, god of ambition]=];
CardNumber="AKH101";
Rulings=2;
MultiverseID=426803;
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[Destroy target creature or planeswalker.<br/>
]=];
CardNumber="AKH212a";
Rulings=9;
MultiverseID=426914;
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[When New Perspectives enters the battlefield, draw three cards.<br/>
...
Rarity="Mythic Rare";
Rarities={"Mythic Rare"};
Text=[=[Take an extra turn after this one.<br/>
...
Rarity="Mythic Rare";
Rarities={"Mythic Rare"};
Text=[=[+3: Each opponent loses 3 life unless that player sacrifices a nonland permanent or discards a card.<br/>
−3: Destroy target creature. Draw a card.<br/>
...
Flavor=[=["One head watches for Consulate enforcers. The other watches for renegade thieves."<br/>
—Crime Lord Gonti]=];
CardNumber="AER166";
Power="3";
Toughness="1";
...
Flavor=[=[The Consulate rarely cracks the coded announcement of a night market's location before dawn, and enforcers are taken care of if they wander too close.]=];
CardNumber="KLD95";
Power="1";
Toughness="1";
Rulings=3;
...
Text=[=[Flash<br/>
Flying<br/>
Cycling {{2}}{{U}} ({{2}}{{U}}, Discard this card: Draw a card.)<br/>
...
Flavor=[=["In the Hour of Glory, the gods and the untested will prove their worth before the God-Pharaoh."<br/>
—The Accounting of Hours]=];
CardNumber="AKH145";
Power="1";
Toughness="3";
...
Rarity="Mythic Rare";
Rarities={"Mythic Rare"};
Text=[=[+2: Untap up to two target creatures and up to two target lands.<br/>
−3: Target creature gets +5/+5 until end of turn.<br/>
...
Rarity="Mythic Rare";
Rarities={"Mythic Rare"};
Text=[=[+3: You gain 3 life.<br/>
−4: Reveal the top two cards of your library. Put all land cards from among them onto the battlefield and the rest into your hand.<br/>
...
Rarities={"Mythic Rare"};
Text=[=[+2: Scry 2.<br/>
0: Look at the top card of your library. If it's a land card or a creature card with converted mana cost less than or equal to the number of loyalty counters on Nissa, Steward of Elements, you may put that card onto the battlefield.<br/>
...
Rarity="Mythic Rare";
Rarities={"Mythic Rare"};
Text=[=[+1: Untap target land you control. Until your next turn, it becomes a 5/5 Elemental creature with haste. It's still a land.<br/>
−3: Return target permanent card from your graveyard to your hand.<br/>
...
Flavor=[=["The soul of this world is gone, Nissa, and I would gladly kill it again."<br/>
—Nicol Bolas]=];
CardNumber="HOU123";
Rulings=1;
MultiverseID=430812;
...
MultiverseID=447327;
Sets={
{Set="W17";Rarity="Common";CardNumber="25";Flavor=[=["When the beast cloaks itself in the mighty oak, what good is a bow? When the oak wraps itself around the snarling beast, what good is a hatchet?"
—Dionus, elvish archdruid]=];};
};
};
...
Rarity="Common";
Rarities={"Common"};
Text=[=[{{2}}{{G}}, {{Tap}}, Sacrifice Oashra Cultivator: Search your library for a basic land card, put it onto the battlefield tapped, then shuffle your library.]=];
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[When Oath of Ajani enters the battlefield, put a +1/+1 counter on each creature you control.<br/>
...
Rarities={"Uncommon"};
Text=[=[Reach<br/>
Whenever Obelisk Spider deals combat damage to a creature, put a -1/-1 counter on that creature.<br/>
...
Rarity="Mythic Rare";
Rarities={"Mythic Rare"};
Text=[=[Double strike, indestructible<br/>
Oketra the True can't attack or block unless you control at least three other creatures.<br/>
...
Rarities={"Uncommon"};
Text=[=[Flying<br/>
Cycling {{2}} ({{2}}, Discard this card: Draw a card.)<br/>
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[White creature spells you cast cost {{1}} less to cast.<br/>
Whenever you cast a creature spell, create a 1/1 white Warrior creature token with vigilance.]=];
Flavor=[=["The worthy shall respect the worthy. In the afterlife, all will stand united."<br/>
—Monument inscription]=];
CardNumber="AKH233";
Rulings=4;
MultiverseID=426935;
...
Flavor=[=["The things I once imagined would be my greatest achievements were only the first steps toward a future I can only begin to fathom."<br/>
—Jace Beleren]=];
CardNumber="M1965";
Rulings=4;
MultiverseID=447201;
...
Flavor=[=["When I grafted the Planar Bridge into myself I felt my Planeswalker spark flare beyond my body. The Multiverse was my plaything. It felt . . . incredible."<br/>
—Tezzeret]=];
CardNumber="M1966";
Rulings=1;
MultiverseID=447202;
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[Target creature gets +X/+0 until end of turn, where X is its power.<br/>
]=];
CardNumber="AKH218a";
Rulings=10;
MultiverseID=426920;
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[{{2}}, {{Tap}}: Exile the top card of your library. Until end of turn, you may play that card. Put a brick counter on Oracle's Vault.<br/>
...
Rarity="Common";
Rarities={"Common"};
Flavor=[=[The leonin of Oreskos are quick to take offense—not because they are thin-skinned, but because they are always ready for a fight.]=];
CardNumber="M1931";
Power="3";
Toughness="1";
MultiverseID=447167;
...
Rarities={"Uncommon"};
Text=[=[Flying]=];
Flavor=[=["You want to know what we are fighting for? Look at the wonder in that child's eyes."<br/>
—Pia Nalaar]=];
CardNumber="AER167";
Power="0";
Toughness="2";
...
Rarities={"Mythic Rare"};
Text=[=[Enchant player<br/>
Creatures enchanted player controls lose all abilities and have base power and toughness 1/1.<br/>
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[{{2}}{{G}}, {{Tap}}: Create a 1/1 colorless Servo artifact creature token.<br/>
{{4}}{{G}}, {{Tap}}: Create an X/X colorless Construct artifact creature token, where X is the number of creatures you control.]=];
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[{{2}}, {{Tap}}: Tap target artifact or creature.]=];
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[Artifacts you control have hexproof.<br/>
...
Flavor=[=["You wish to remember this lesson? I will write it down for you."<br/>
...
Rarity="Mythic Rare";
Rarities={"Mythic Rare"};
Text=[=[Flying, vigilance, trample<br/>
...
Flavor=[=["One look at this glorious item convinced me that Kaladesh deserved my full attention. Sure enough, my time here has yielded exquisite fruit."<br/>
—Tezzeret]=];
CardNumber="AER169";
Rulings=1;
MultiverseID=423836;
...
Rarity="Common";
Rarities={"Common"};
Text=[=[{{Tap}}: Target creature with power 2 or less can't be blocked this turn.]=];
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[{{1}}{{W}}: Another target Vehicle you control becomes an artifact creature until end of turn.<br/>
Crew 4 (Tap any number of creatures you control with total power 4 or more: This Vehicle becomes an artifact creature until end of turn.)]=];
Flavor=[=["Peace? Its sole purpose is fear."<br/>
—Saheeli Rai]=];
CardNumber="AER170";
Power="6";
Toughness="6";
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[When Peema Aether-Seer enters the battlefield, you get an amount of {{E}} (energy counters) equal to the greatest power among creatures you control.<br/>
...
MultiverseID=447168;
Sets={
{Set="DOM";Rarity="Common";CardNumber="29";Flavor=[=[A pegasus chooses its rider, bearing the worthy into the clouds and tossing all others to the ground.]=];};
};
};
...
Rarities={"Rare"};
Text=[=[Trample<br/>
When Pelakka Wurm enters the battlefield, you gain 7 life.<br/>
...
Rarity="Common";
Rarities={"Common"};
Text=[=[When Pendulum of Patterns enters the battlefield, you gain 3 life.<br/>
{{5}}, {{Tap}}, Sacrifice Pendulum of Patterns: Draw a card.]=];
Flavor=[=[Its elaborate designs reveal secrets of aether's flow.]=];
CardNumber="M19288";
MultiverseID=450235;
Sets={
{Set="AER";Rarity="Common";CardNumber="192";Flavor=[=[Its elaborate designs reveal secrets of aether's flow.]=];};
};
};
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[{{Tap}}: Put the top two cards of your library into your graveyard.<br/>
...
Rarities={"Rare"};
Text=[=[Indestructible<br/>
As Phylactery Lich enters the battlefield, put a phylactery counter on an artifact you control.<br/>
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[When Pia Nalaar enters the battlefield, create a 1/1 colorless Thopter artifact creature token with flying.<br/>
{{1}}{{R}}: Target artifact creature gets +1/+0 until end of turn.<br/>
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[Whenever a nontoken artifact is put into your graveyard from the battlefield, return that card to your hand unless target opponent has Pia's Revolution deal 3 damage to them.]=];
...
Rarities={"Rare"};
Text=[=[Menace<br/>
When Plague Belcher enters the battlefield, put two -1/-1 counters on target creature you control.<br/>
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[Plague Mare can't be blocked by white creatures.<br/>
...
MultiverseID=447399;
Sets={
{Set="KLD";Rarity="Basic Land";CardNumber="250";};
...
Rarity="Mythic Rare";
Rarities={"Mythic Rare"};
Text=[=[{{8}}, {{Tap}}: Search your library for a permanent card, put it onto the battlefield, then shuffle your library.]=];
Flavor=[=["It is finished. Now the real work can begin."<br/>
—Tezzeret]=];
CardNumber="AER171";
Rulings=1;
MultiverseID=423838;
...
Rarities={"Uncommon"};
Text=[=[Reach (This creature can block creatures with flying.)<br/>
Deathtouch (Any amount of damage this deals to a creature is enough to destroy it.)<br/>
...
Rarity="Common";
Rarities={"Common"};
Flavor=[=[It's rare that the Prakhata Club closes its doors. It's also rare that Lord Gonti meets with Consul Kambal. What are the odds the two would occur on the same day?]=];
CardNumber="KLD98";
Power="3";
Toughness="4";
MultiverseID=417671;
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[Untap target creature. It gets +2/+2 and gains lifelink until end of turn.<br/>
]=];
CardNumber="AKH220a";
Rulings=12;
MultiverseID=426922;
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[Pride Sovereign gets +1/+1 for each other Cat you control.<br/>
{{W}}, {{Tap}}, Exert Pride Sovereign: Create two 1/1 white Cat creature tokens with lifelink. (An exerted creature won't untap during your next untap step.)]=];
CardNumber="HOU126";
Power="2";
Toughness="2";
Rulings=5;
...
Rarity="Common";
Rarities={"Common"};
Flavor=[=[The Scrappers, an underground group with a passion for automaton brawls, had renegade leanings even before the Consulate's crackdown. It didn't take long for them to lend their best brawlers to the conflict.]=];
CardNumber="AER172";
Power="6";
Toughness="2";
MultiverseID=423839;
...
Flavor=[=["Look how cute it is now!"<br/>
—Vivien Reid]=];
CardNumber="M19194";
MultiverseID=447330;
};
...
Rarity="Common";
Rarities={"Common"};
Text=[=[When Prophetic Prism enters the battlefield, draw a card.<br/>
{{1}}, {{Tap}}: Add one mana of any color.]=];
...
Flavor=[=[Part of the acolytes' training is to walk along the Hekma, staring out at the ravenous horrors kept at bay by the God-Pharaoh's barrier.]=];
CardNumber="AKH23";
Rulings=2;
MultiverseID=426725;
};
...
Flavor=[=["To break another's mind is to deliver a fate worse than death. It is a terrifying power."<br/>
—Jace Beleren]=];
CardNumber="M1968";
Rulings=1;
MultiverseID=447204;
...
Flavor=[=["I turn around and see nothing, yet I know it is behind me. Its fingers rummage in my mind, crafting new ideas."]=];
CardNumber="M19221";
Power="3";
Toughness="3";
Rulings=1;
...
Flavor=[=["I do things in my own time."<br/>
—Etha, initiate of Rhet crop]=];
CardNumber="AKH65";
MultiverseID=426767;
};
...
Flavor=[=["Neither the false God-Pharaoh nor his bugs will decide our fate."<br/>
—Samut, former Tah-crop initiate]=];
CardNumber="HOU106";
Rulings=1;
MultiverseID=430795;
...
Rarity="Common";
Rarities={"Common"};
Text=[=[Attacking creatures get +2/+0 until end of turn.<br/>
Cycling {{2}} ({{2}}, Discard this card: Draw a card.)]=];
Flavor=[=["Combat is a form of worship, the clash of steel a solemn prayer."<br/>
—Pytamun, initiate of Nef crop]=];
CardNumber="AKH147";
MultiverseID=426849;
};
...
Flavor=[=["The ruin of the past is the topsoil of the future."<br/>
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[When Quicksmith Rebel enters the battlefield, target artifact you control gains "{{Tap}}: This artifact deals 2 damage to any target" for as long as you control Quicksmith Rebel.]=];
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[When Quicksmith Spy enters the battlefield, target artifact you control gains "{{Tap}}: Draw a card" for as long as you control Quicksmith Spy.]=];
...
MultiverseID=447331;
Sets={
{Set="W17";Rarity="Common";CardNumber="26";Flavor=[=["You should have seen the look on both their faces."
—Morkamp, Lambholt innkeeper]=];};
};
};
...
MultiverseID=450260;
Sets={
{Set="DOM";Rarity="Common";CardNumber="138";Flavor=[=[As the Cabal legions pushed into Shiv, they learned not to stand so close together.]=];};
};
};
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[All creatures get -2/-2 until end of turn.<br/>
]=];
CardNumber="AKH222a";
Rulings=10;
MultiverseID=426924;
...
Flavor=[=[The earth cannot hold that which magic commands.]=];
CardNumber="W1718";
Rulings=2;
MultiverseID=429907;
};
...
Text=[=[Trample<br/>
Cycling {{2}} ({{2}}, Discard this card: Draw a card.)]=];
Flavor=[=["Respect is earned through deeds—or the capacity to bite someone in half."<br/>
...
Ramunap Hydra gets +1/+1 as long as you control a Desert.<br/>
...
Flavor=[=["I've made some fine acquisitions of late, so I'm planning to make commensurate improvements to my security systems. I have a consultant coming tomorrow."<br/>
—Kurna Majan, Luminary League]=];
CardNumber="AER94";
Power="1";
Toughness="2";
MultiverseID=423761;
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[Search your library for a card and put that card into your hand. Then shuffle your library.<br/>
Cycling {{B}} ({{B}}, Discard this card: Draw a card.)]=];
...
Flavor=[=["They may show up with the wrong thigh bone or mandible, but they always show up."<br/>
—Zul Ashur, lich lord]=];
CardNumber="M19116";
Power="1";
Toughness="1";
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[Counter target spell unless its controller pays {{3}}.<br/>
]=];
CardNumber="AKH216a";
Rulings=9;
MultiverseID=426918;
...
Flavor=[=["There's no reason to buy a new one when I've got the tools to fix the one you've got."<br/>
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[Refuse deals damage to target spell's controller equal to that spell's converted mana cost.<br/>
]=];
CardNumber="HOU156a";
Rulings=10;
MultiverseID=430845;
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[Other Cats you control get +1/+1 and have lifelink.<br/>
...
Flavor=[=["Being an inventor means knowing how to use the tools at hand to make something great—or to bring it down."<br/>
—Pia Nalaar]=];
CardNumber="AER96";
Rulings=3;
MultiverseID=423763;
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[You have no maximum hand size.<br/>
{{Tap}}: Add {{C}}.]=];
...
Rarity="Common";
Rarities={"Common"};
Text=[=[Whenever Renegade Freighter attacks, it gets +1/+1 and gains trample until end of turn.<br/>
Crew 2 (Tap any number of creatures you control with total power 2 or more: This Vehicle becomes an artifact creature until end of turn.)]=];
CardNumber="KLD230";
Power="4";
Toughness="3";
...
Rarity="Common";
Rarities={"Common"};
Text=[=[Renegade Map enters the battlefield tapped.<br/>
...
Rarity="Common";
Rarities={"Common"};
Text=[=[Target creature can't block this turn.<br/>
Draw a card.]=];
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[You gain 6 life.<br/>
Cycling {{1}}{{W}} ({{1}}{{W}}, Discard this card: Draw a card.)<br/>
...
cmc=2;
Colors={"Green"};
Type="Creature — Jackal Wizard";
Types={"Creature"};
SubTypes={"Jackal";"Wizard";};
Rarity="Rare";
Rarities={"Rare"};
Text=[=[When Resilient Khenra enters the battlefield, you may have target creature get +X/+X until end of turn, where X is Resilient Khenra's power.<br/>
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[You may exert Resolute Survivors as it attacks. (It won't untap during your next untap step.)<br/>
...
Rarity="Common";
Rarities={"Common"};
Text=[=[You gain 3 life.<br/>
Draw a card.]=];
Flavor=[=["A potion is no substitute for a skilled surgeon, but it will hold your bits in."<br/>
...
Rarity="Mythic Rare";
Rarities={"Mythic Rare"};
Text=[=[Deathtouch, indestructible<br/>
Rhonas the Indomitable can't attack or block unless you control another creature with power 4 or greater.<br/>
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[Green creature spells you cast cost {{1}} less to cast.<br/>
Whenever you cast a creature spell, target creature you control gets +2/+2 and gains trample until end of turn.]=];
Flavor=[=["The worthy shall hone a strong body to endure the boundless energies of the afterlife."<br/>
—Monument inscription]=];
CardNumber="AKH236";
Rulings=5;
MultiverseID=426938;
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[Whenever you cast a noncreature spell, you may have Riddleform become a 3/3 Sphinx creature with flying in addition to its other types until end of turn.<br/>
{{2}}{{U}}: Scry 1.]=];
CardNumber="HOU43";
Rulings=2;
MultiverseID=430732;
...
Flavor=[=["Each creature holds a solution to a problem, a lesson to be learned."<br/>
—Oviya Pashiri, sage lifecrafter]=];
CardNumber="AER121";
Power="5";
Toughness="5";
...
Rarities={"Common"};
Text=[=[Trample<br/>
When Riparian Tiger enters the battlefield, you get {{E}}{{E}} (two energy counters).<br/>
...
Flavor=[=["Death is no excuse for disobedience."<br/>
—Liliana Vess]=];
CardNumber="M19117";
Rulings=3;
MultiverseID=447253;
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[When Rishkar, Peema Renegade enters the battlefield, put a +1/+1 counter on each of up to two target creatures.<br/>
Each creature you control with a counter on it has "{{Tap}}: Add {{G}}."]=];
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[Draw cards equal to the greatest power among creatures you control.<br/>
...
Flavor=[=["It's a cruel thing to give such a sad song to such a colorful creature."<br/>
—Sana, former Ahn-crop initiate]=];
CardNumber="HOU143";
Power="1";
Toughness="3";
...
Rarity="Common";
Rarities={"Common"};
Text=[=[River Serpent can't attack unless there are five or more cards in your graveyard.<br/>
Cycling {{U}} ({{U}}, Discard this card: Draw a card.)]=];
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[Whenever equipped creature deals combat damage to a player, you may draw a card.<br/>
Equip {{2}} ({{2}}: Attach to target creature you control. Equip only as a sorcery.)]=];
...
Flavor=[=[They make terrible pets . . . unless you don't like your other pets.]=];
CardNumber="W1727";
Power="2";
Toughness="2";
Rulings=1;
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[Rupture Spire enters the battlefield tapped.<br/>
When Rupture Spire enters the battlefield, sacrifice it unless you pay {{1}}.<br/>
{{Tap}}: Add one mana of any color.]=];
CardNumber="M19255";
MultiverseID=447392;
};
...
Rarity="Mythic Rare";
Rarities={"Mythic Rare"};
Text=[=[+1: Scry 1. Saheeli Rai deals 1 damage to each opponent.<br/>
−2: Create a token that's a copy of target artifact or creature you control, except it's an artifact in addition to its other types. That token gains haste. Exile it at the beginning of the next end step.<br/>
...
Rarities={"Rare"};
Text=[=[Choose one or both —<br/>
• Create a token that's a copy of target artifact.<br/>
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[Whenever you cast an artifact spell, create a 1/1 colorless Thopter artifact creature token with flying.<br/>
{{1}}{{U}}, Sacrifice two artifacts: Draw a card.]=];
Flavor=[=["Industry without artistry is just a fancy way to fill the junkyard."]=];
CardNumber="M1969";
Power="1";
Toughness="4";
Rulings=1;
...
Rarities={"Mythic Rare"};
Text=[=[Flash<br/>
Double strike, vigilance, haste<br/>
Other creatures you control have haste.<br/>
...
Flavor=[=[The sands of Amonkhet can be as much a boon as a bane. It depends entirely on which way the wind blows.]=];
CardNumber="HOU20";
MultiverseID=430709;
};
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[Creatures with flying can't attack you or planeswalkers you control.<br/>
...
Rarity="Mythic Rare";
Rarities={"Mythic Rare"};
Text=[=[+2: Sarkhan, Dragonsoul deals 1 damage to each opponent and each creature your opponents control.<br/>
−3: Sarkhan, Dragonsoul deals 4 damage to target player or planeswalker.<br/>
...
Rarity="Mythic Rare";
Rarities={"Mythic Rare"};
Text=[=[+1: You may discard a card. If you do, draw a card.<br/>
+1: Add two mana in any combination of colors. Spend this mana only to cast Dragon spells.<br/>
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[Sarkhan's Dragonfire deals 3 damage to any target.<br/>
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[Whenever you cast a creature spell with power 4, 5, or 6, Sarkhan's Unsealing deals 4 damage to any target.<br/>
...
Flavor=[=["The threads of magic that protect this place were woven by my will."]=];
CardNumber="M19223";
Power="2";
Toughness="2";
Rulings=1;
...
Rarities={"Uncommon"};
Text=[=[Flash<br/>
Enchant creature you control<br/>
When Saving Grace enters the battlefield, all damage that would be dealt this turn to you and permanents you control is dealt to enchanted creature instead.<br/>
...
Flavor=[=["Whether we like it or not, our arrival has altered the landscape."<br/>
—Malcolm, navigator of the &lt;i&gt;Belligerent&lt;/i&gt;]=];
CardNumber="M19201";
Rulings=1;
MultiverseID=447337;
};
...
Rarity="Common";
Rarities={"Common"};
Text=[=[Exile up to three target cards from a single graveyard.<br/>
Cycling {{B}} ({{B}}, Discard this card: Draw a card.)]=];
Flavor=[=["The face of mediocrity is wrapped in anointed linen. Aspire to a better end."<br/>
—Epnokep, vizier of Bontu]=];
CardNumber="AKH106";
MultiverseID=426808;
};
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[Double strike (This creature deals both first-strike and regular combat damage.)<br/>
When Scrapper Champion enters the battlefield, you get {{E}}{{E}} (two energy counters).<br/>
...
Rarity="Common";
Rarities={"Common"};
Text=[=[{{1}}, {{Tap}}, Sacrifice Scribe of the Mindful: Return target instant or sorcery card from your graveyard to your hand.]=];
Flavor=[=["The best answers solve more than one riddle."<br/>
—Kefnet, god of knowledge]=];
CardNumber="AKH68";
Power="2";
Toughness="2";
...
cmc=2;
Colors={"Green"};
Type="Creature — Cat Monkey";
Types={"Creature"};
SubTypes={"Cat";"Monkey";};
Rarity="Common";
Rarities={"Common"};
Text=[=[Scrounging Bandar enters the battlefield with two +1/+1 counters on it.<br/>
...
Rarity="Common";
Rarities={"Common"};
Text=[=[{{Tap}}: Draw a card, then discard a card. Activate this ability only if you've cast a noncreature spell this turn.]=];
...
Flavor=[=[Empires rise and fall, but evil is eternal.]=];
CardNumber="W1719";
Power="4";
Toughness="4";
Rulings=3;
...
Rarities={"Uncommon"};
Text=[=[{{Tap}}: Add {{C}}.<br/>
{{4}}, {{Tap}}, Sacrifice Sequestered Stash: Put the top five cards of your library into your graveyard. Then you may put an artifact card from your graveyard on top of your library.]=];
CardNumber="KLD248";
Rulings=1;
MultiverseID=417821;
};
...
Flavor=[=["Angels? My feelings remain unchanged."<br/>
—Liliana Vess]=];
CardNumber="AKH28";
Power="4";
Toughness="4";
...
MultiverseID=442921;
Sets={
{Set="W17";Rarity="Uncommon";CardNumber="3";Flavor=[=[Follow the light. In its absence, follow her.]=];};
};
};
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[When Servant of the Conduit enters the battlefield, you get {{E}}{{E}} (two energy counters).<br/>
{{Tap}}, Pay {{E}}: Add one mana of any color.]=];
...
Flavor=[=["The judges really put them through their paces, but they prevailed. I think they even impressed Head Judge Tezzeret."<br/>
—Ritika, artificer]=];
CardNumber="KLD27";
MultiverseID=417600;
};
...
Flavor=[=["Death has seeped into every part of this plane. I can feel it on my skin and taste it like sand in my mouth."<br/>
—Nissa Revane]=];
CardNumber="AKH107";
Rulings=2;
MultiverseID=426809;
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[Cycling {{3}}{{G}} ({{3}}{{G}}, Discard this card: Draw a card.)<br/>
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[Shield Mare can't be blocked by red creatures.<br/>
...
Rarities={"Uncommon"};
Text=[=[Flash (You may cast this spell any time you could cast an instant.)<br/>
Whenever Shielded Aether Thief blocks, you get {{E}} (an energy counter).<br/>
...
Rarity="Common";
Rarities={"Common"};
Text=[=[When Shipwreck Moray enters the battlefield, you get {{E}}{{E}}{{E}}{{E}} (four energy counters).<br/>
...
MultiverseID=450247;
Sets={
{Set="W17";Rarity="Rare";CardNumber="22";Flavor=[=[The undisputed master of the mountains of Shiv.]=];};
};
};
...
MultiverseID=447292;
Sets={
{Set="AER";Rarity="Common";CardNumber="98";Flavor=[=[The tools of invention became the weapons of revolution.]=];};
};
};
...
Flavor=[=["Those who embrace the harsh land rather than fight it find they have a powerful ally."<br/>
—Nissa Revane]=];
CardNumber="HOU134";
Power="3";
Toughness="2";
...
Flavor=[=["Rhonas's monument belongs to the wurms now. Look elsewhere for refuge."<br/>
—Arnun, vizier of the menagerie]=];
CardNumber="HOU135";
Power="7";
Toughness="7";
Rulings=3;
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[Equipped creature gets +2/+0, has vigilance, and is a Knight in addition to its other types.<br/>
Whenever equipped creature attacks, create a 2/2 white Knight creature token with vigilance that's attacking.<br/>
Equip {{3}}]=];
CardNumber="M19244";
Rulings=2;
MultiverseID=447381;
...
Rarities={"Common"};
Text=[=[Flying (This creature can't be blocked except by creatures with flying or reach.)]=];
Flavor=[=[A pair of domesticated griffins escaped from captivity a century ago. Now the skies are filled with the songs of their descendants.]=];
CardNumber="M19285";
Power="2";
Toughness="2";
MultiverseID=450232;
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[{{U}}: Sinuous Striker gets +1/-1 until end of turn.<br/>
...
Flavor=[=["This imprint was the familiar of a friend."<br/>
—Vivien Reid]=];
CardNumber="M19303";
Power="3";
Toughness="3";
...
MultiverseID=447255;
Sets={
{Set="XLN";Rarity="Common";CardNumber="124";Flavor=[=[From the perpetual shadowsmoke that hung above the ship, a silent form emerged, lips curled with malice and anticipation.]=];};
};
};
...
Rarities={"Rare"};
Text=[=[Flying<br/>
{{R}}: Skyship Stalker gets +1/+0 until end of turn.<br/>
{{R}}: Skyship Stalker gains first strike until end of turn.<br/>
...
Rarities={"Mythic Rare"};
Text=[=[Flying<br/>
Whenever Skysovereign, Consul Flagship enters the battlefield or attacks, it deals 3 damage to target creature or planeswalker an opponent controls.<br/>
Crew 3 (Tap any number of creatures you control with total power 3 or more: This Vehicle becomes an artifact creature until end of turn.)]=];
CardNumber="KLD234";
Power="6";
Toughness="5";
...
Flavor=[=[In the moment of truth, it is as though time stands still, and the whale waits, suspended in the sky.]=];
CardNumber="KLD29";
Rulings=1;
MultiverseID=417602;
};
...
Flavor=[=["I give them dreams so wondrous that they hesitate to return to the world of the conscious."<br/>
—Garild, merfolk mage]=];
CardNumber="M1974";
Rulings=1;
MultiverseID=447210;
...
Flavor=[=[Some naga initiates move as silently as the suns' reflections on the water.]=];
CardNumber="AKH71";
Power="1";
Toughness="2";
MultiverseID=426773;
...
Rarities={"Rare"};
Text=[=[Flying<br/>
Whenever Smuggler's Copter attacks or blocks, you may draw a card. If you do, discard a card.<br/>
Crew 1 (Tap any number of creatures you control with total power 1 or more: This Vehicle becomes an artifact creature until end of turn.)]=];
CardNumber="KLD235";
Power="3";
Toughness="3";
...
Rarities={"Uncommon"};
Text=[=[Flying, haste]=];
Flavor=[=["I did not think I would understand the cold filigree creatures of this world, but they too are governed by the laws of nature."<br/>
—Nissa Revane]=];
CardNumber="KLD236";
Power="3";
Toughness="2";
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[Players can't get counters.<br/>
...
Types={"Creature"};
SubTypes={"Scorpion";"Demon";};
Rarity="Common";
Rarities={"Common"};
Text=[=[When Soulstinger enters the battlefield, put two -1/-1 counters on target creature you control.<br/>
...
Flavor=[=["You have given all to your kingdom, dear knight. Serenity shall be your prize."<br/>
—Queen Lian]=];
CardNumber="M19120";
MultiverseID=447256;
};
...
Flavor=[=["To invent is to rebel."<br/>
—Pia Nalaar]=];
CardNumber="KLD131";
Rulings=5;
MultiverseID=417704;
...
cmc=2;
Colors={"Blue"};
Type="Creature — Zombie Naga Wizard";
Types={"Creature"};
SubTypes={"Zombie";"Naga";"Wizard";};
Rarity="Common";
Rarities={"Common"};
Text=[=[Prowess (Whenever you cast a noncreature spell, this creature gets +1/+1 until end of turn.)<br/>
Afflict 2 (Whenever this creature becomes blocked, defending player loses 2 life.)]=];
Flavor=[=["They were once our brothers and sisters."<br/>
—Etha, former Rhet-crop initiate]=];
CardNumber="HOU46";
Power="2";
Toughness="1";
Rulings=4;
...
Flavor=[=["A riddle is nothing more than a trap for small minds, baited with the promise of understanding."]=];
CardNumber="W1712";
Power="6";
Toughness="6";
MultiverseID=429901;
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[Spirebluff Canal enters the battlefield tapped unless you control two or fewer other lands.<br/>
{{Tap}}: Add {{U}} or {{R}}.]=];
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[Spit Flame deals 4 damage to target creature.<br/>
...
Flavor=[=["Wherever you are in the city, you can feel the presence of the God-Pharaoh. Take comfort in that."<br/>
—Ukhat, vizier of initiation]=];
CardNumber="AKH109";
Rulings=2;
MultiverseID=426811;
...
Rarity="Common";
Rarities={"Common"};
Text=[=[When Spontaneous Artist enters the battlefield, you get {{E}} (an energy counter).<br/>
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[Create three 1/1 colorless Servo artifact creature tokens.<br/>
...
Flavor=[=[In the Jamuraan jungles, there is often no separating beauty from danger.]=];
CardNumber="W1728";
Power="3";
Toughness="3";
MultiverseID=429917;
...
Rarities={"Common"};
Text=[=[Trample (This creature can deal excess combat damage to the player or planeswalker it's attacking.)]=];
Flavor=[=[The quickest way to get through the jungle is to agitate a rhino and run in its wake.]=];
CardNumber="W1729";
Power="4";
Toughness="4";
MultiverseID=429918;
...
Rarities={"Common"};
Text=[=[Vigilance]=];
Flavor=[=["Bant sentries were called the Angel Line. They never faltered, and they were ready to die defending their position."<br/>
—Elspeth Tirel]=];
CardNumber="W174";
Power="1";
Toughness="4";
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[Create two 1/1 white Warrior creature tokens with vigilance.<br/>
]=];
CardNumber="AKH215a";
Rulings=9;
MultiverseID=426917;
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[{{Tap}}, Exert Steward of Solidarity: Create a 1/1 white Warrior creature token with vigilance. (An exerted creature won't untap during your next untap step.)]=];
...
Rarity="Common";
Rarities={"Common"};
Text=[=[Put three -1/-1 counters on target creature with flying.<br/>
Cycling {{2}} ({{2}}, Discard this card: Draw a card.)]=];
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[Create three 2/2 black Zombie creature tokens.<br/>
Cycling {{3}}{{B}} ({{3}}{{B}}, Discard this card: Draw a card.)<br/>
...
MultiverseID=447393;
Sets={
{Set="KLD";Rarity="Common";CardNumber="269";Flavor=[=[The Inventors' Renaissance came on the heels of the Great Aether Boom, hiking demand for raw materials of every kind.]=];};
{Set="AKH";Rarity="Common";CardNumber="274";Flavor=[=[Entire valleys have been formed by mummies laboring to find veins of lazotep.]=];};
...
Rarities={"Uncommon"};
Text=[=[Flying]=];
Flavor=[=[Its hooves touch the earth only when a hero must rise.]=];
CardNumber="W175";
Power="2";
Toughness="1";
MultiverseID=429894;
...
Flavor=[=[Imagine a thousand tiny mushrooms cropping up within your lungs.]=];
CardNumber="M19122";
MultiverseID=447258;
};
...
Flavor=[=["Bolas remade this place in his image. He has the advantage here. We must approach carefully."<br/>
—Jace Beleren]=];
CardNumber="HOU47";
Rulings=1;
MultiverseID=430736;
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[Struggle deals damage to target creature equal to the number of lands you control.<br/>
]=];
CardNumber="HOU151a";
Rulings=9;
MultiverseID=430840;
...
{{Tap}}: Add {{U}} or {{B}}.]=];
Flavor=[=["Long after the land has given up the last of its secrets, there will still be mysteries in the depths of the sea."<br/>
—Kiora]=];
CardNumber="M19257";
MultiverseID=447394;
Sets={
{Set="AER";Rarity="Common";CardNumber="194";Flavor=[=[Aether currents in the sky mirror water currents below, including the deadly rapids.]=];};
{Set="AKH";Rarity="Common";CardNumber="284";Flavor=[=[Aether currents in the sky mirror water currents below, including the deadly rapids.]=];};
};
};
...
Rarities={"Common"};
Text=[=[Vigilance (Attacking doesn't cause this creature to tap.)]=];
Flavor=[=[Just as the sun rises at dawn and the days lengthen in summer, the Sun Empire has awakened after long years of quiet.]=];
CardNumber="M19307";
Power="2";
Toughness="2";
MultiverseID=450254;
Sets={
{Set="RIX";Rarity="Common";CardNumber="26";Flavor=[=["I will not sleep until Orazca is ours once more."]=];};
};
};
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[When Suncleanser enters the battlefield, choose one —<br/>
• Remove all counters from target creature. It can't have counters put on it for as long as Suncleanser remains on the battlefield.<br/>
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[When Sunscourge Champion enters the battlefield, you gain life equal to its power.<br/>
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[Sunset Pyramid enters the battlefield with three brick counters on it.<br/>
{{2}}, {{Tap}}, Remove a brick counter from Sunset Pyramid: Draw a card.<br/>
{{2}}, {{Tap}}: Scry 1.]=];
...
Rarities={"Common"};
Text=[=[Until end of turn, target creature gets +2/+0 and gains "When this creature dies, return it to the battlefield tapped under its owner's control."]=];
Flavor=[=["All are not equal—neither in life nor after death. Bontu's favorites will stand highest in eternity."<br/>
—Senifet, vizier of Bontu]=];
CardNumber="AKH111";
Rulings=1;
MultiverseID=426813;
...
Flavor=[=["We each have a weight to carry on the road to the afterlife."<br/>
—Oketra, god of solidarity]=];
CardNumber="AKH30";
Power="3";
Toughness="5";
...
Rarities={"Uncommon"};
Text=[=[Choose one —<br/>
• Counter target spell unless its controller pays {{3}}.<br/>
...
MultiverseID=447297;
Sets={
{Set="XLN";Rarity="Common";CardNumber="166";Flavor=[=["Everyone has a weak spot."]=];};
};
};
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[Surge Mare can't be blocked by green creatures.<br/>
Whenever Surge Mare deals damage to an opponent, you may draw a card. If you do, discard a card.<br/>
...
Flavor=[=[All the books were dusty with disuse, save the one titled &lt;i&gt;Camouflage and Its Practical Applications&lt;/i&gt;.]=];
CardNumber="M19246";
Power="0";
Toughness="4";
Rulings=1;
...
MultiverseID=447407;
Sets={
{Set="KLD";Rarity="Basic Land";CardNumber="256";};
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[Sweltering Suns deals 3 damage to each creature.<br/>
Cycling {{3}} ({{3}}, Discard this card: Draw a card.)]=];
...
Rarities={"Common"};
Text=[=[Choose one —<br/>
• Take Down deals 4 damage to target creature with flying.<br/>
...
Rarities={"Common"};
Text=[=[Enchant creature<br/>
Enchanted creature gets +1/+1 and has trample. (It can deal excess combat damage to the player or planeswalker it's attacking.)<br/>
...
Flavor=[=[The dead who wander beyond the safety of the city of Naktamun crave only to spread their curse.]=];
CardNumber="M19295";
Power="1";
Toughness="2";
Rulings=2;
MultiverseID=450242;
Sets={
{Set="AKH";Rarity="Common";CardNumber="278";Flavor=[=[The dead who wander beyond the safety of the city crave only to spread their curse.]=];};
};
};
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[At the beginning of combat on your turn, target creature token you control gets +1/+1 until end of turn and can't be blocked this turn.<br/>
...
Rarity="Common";
Rarities={"Common"};
Flavor=[=["You tread upon the land all the time, yet you seem dismayed when it moves to step on you."<br/>
—Nissa Revane]=];
CardNumber="KLD272";
Power="3";
Toughness="2";
...
Rarity="Common";
Rarities={"Common"};
Flavor=[=["Consider this a high alert, people. Permission to destroy on sight. Either we take it down or it'll take down the Fair."<br/>
—Pav, gremlin watch]=];
CardNumber="KLD137";
Power="5";
Toughness="2";
...
Rarity="Mythic Rare";
Rarities={"Mythic Rare"};
Text=[=[+1: Create a colorless artifact token named Etherium Cell with "{{Tap}}, Sacrifice this artifact: Add one mana of any color."<br/>
−2: Target creature gets +X/-X until end of turn, where X is the number of artifacts you control.<br/>
...
Rarity="Mythic Rare";
Rarities={"Mythic Rare"};
Text=[=[+1: Create a 1/1 colorless Thopter artifact creature token with flying.<br/>
0: Draw a card. If you control three or more artifacts, draw two cards instead.<br/>
...
Rarities={"Mythic Rare"};
Text=[=[+1: Draw a card.<br/>
0: Until your next turn, target artifact you control becomes a 5/5 creature in addition to its other types.<br/>
...
Rarity="Mythic Rare";
Rarities={"Mythic Rare"};
Text=[=[+1: Reveal cards from the top of your library until you reveal an artifact card. Put that card into your hand and the rest on the bottom of your library in a random order.<br/>
−3: Target opponent loses life equal to the number of artifacts you control.<br/>
...
Flavor=[=["You can't hope to comprehend the plans that are in motion."<br/>
—Tezzeret]=];
CardNumber="AER191";
Rulings=1;
MultiverseID=425698;
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[When Tezzeret's Gatebreaker enters the battlefield, look at the top five cards of your library. You may reveal a blue or artifact card from among them and put it into your hand. Put the rest on the bottom of your library in a random order.<br/>
{{5}}{{U}}, {{Tap}}, Sacrifice Tezzeret's Gatebreaker: Creatures you control can't be blocked this turn.]=];
CardNumber="M19289";
Rulings=1;
MultiverseID=450236;
};
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[{{Tap}}: Target opponent loses 1 life. If you control a Tezzeret planeswalker, that player loses 3 life instead.]=];
...
Flavor=[=["More obedient than any dog."<br/>
—Tezzeret]=];
CardNumber="M19290";
Power="3";
Toughness="1";
...
Rarities={"Uncommon"};
Text=[=[Enchant artifact<br/>
Enchanted artifact is a creature with base power and toughness 5/5 in addition to its other types.<br/>
...
Rarities={"Mythic Rare"};
Text=[=[Flying<br/>
Whenever you draw a card, create a 1/1 blue and red Insect creature token with flying and haste.<br/>
{{2}}{{U}}{{R}}: Draw a card, then discard a card.<br/>
...
Rarity="Mythic Rare";
Rarities={"Mythic Rare"};
Text=[=[At the beginning of your upkeep, each opponent loses X life and you scry X, where X is the number of Zombies you control.<br/>
{{2}}{{U}}{{B}}: Exile target creature card from a graveyard. Create a token that's a copy of it, except it's a 4/4 black Zombie.<br/>
...
Rarity="Mythic Rare";
Rarities={"Mythic Rare"};
Text=[=[Whenever a creature with a -1/-1 counter on it dies, draw a card.<br/>
{{1}}{{B}}{{R}}: Put a -1/-1 counter on another target creature.<br/>
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[Whenever Thorn Lieutenant becomes the target of a spell or ability an opponent controls, create a 1/1 green Elf Warrior creature token.<br/>
...
Rarity="Common";
Rarities={"Common"};
Flavor=[=["Halana grew brambles to create a barricade around our camp, hoping that it would keep the wolves out. That was a mistake for which we almost paid dearly."<br/>
...
Rarity="Common";
Rarities={"Common"};
Flavor=[=["The dead perform all the work here—farming, building, teaching, even embalming their fellow mummies. The living need do nothing but train. What system could be more perfect?"<br/>
—Temmet, vizier of Naktamun]=];
CardNumber="AKH32";
Power="2";
Toughness="4";
...
Rarity="Common";
Rarities={"Common"};
Text=[=[When Thriving Grubs enters the battlefield, you get {{E}}{{E}} (two energy counters).<br/>
...
Rarity="Common";
Rarities={"Common"};
Text=[=[When Thriving Ibex enters the battlefield, you get {{E}}{{E}} (two energy counters).<br/>
...
Rarity="Common";
Rarities={"Common"};
Text=[=[When Thriving Rats enters the battlefield, you get {{E}}{{E}} (two energy counters).<br/>
...
Rarity="Common";
Rarities={"Common"};
Text=[=[When Thriving Rhino enters the battlefield, you get {{E}}{{E}} (two energy counters).<br/>
...
Rarity="Common";
Rarities={"Common"};
Text=[=[When Thriving Turtle enters the battlefield, you get {{E}}{{E}} (two energy counters).<br/>
...
Flavor=[=["When the Second Sun rests between the horns on the horizon, so begins the Hour of Revelation. Then the Hour of Glory, the Hour of Promise, and finally the Hour of Eternity."<br/>
—The Accounting of Hours]=];
CardNumber="AKH237";
Rulings=3;
MultiverseID=426939;
...
Flavor=[=[Aetherborn patrons use any means necessary to secure victory for their protégés.]=];
CardNumber="KLD103";
Rulings=2;
MultiverseID=417676;
};
...
{Set="DOM";Rarity="Common";CardNumber="279";Flavor=[=[Glaciers, torrential floods, and temporal disturbances came and went. The mountains yet stood, unchanged.]=];};
};
};
...
Flavor=[=["Occasionally, there are those who refuse to appreciate all that the God-Pharaoh provides for us."<br/>
—Temmet, vizier of Naktamun]=];
CardNumber="AKH33";
Rulings=2;
MultiverseID=426735;
...
MultiverseID=447216;
Sets={
{Set="DOM";Rarity="Common";CardNumber="71";Flavor=[=[The Tolarian Academies embrace a tradition of study and research while discouraging the kinds of experiments that ruined the original island of Tolaria.]=];};
};
};
...
Text=[=[Equipped creature gets +2/+0.<br/>
Equip {{2}} ({{2}}: Attach to target creature you control. Equip only as a sorcery.)]=];
Flavor=[=["Good morning, children. Please open your aether valves and ignite your gauntlets."<br/>
...
Text=[=[As an additional cost to cast this spell, discard a card.<br/>
Draw two cards.]=];
Flavor=[=["Unwelcome thoughts crowd my mind. Are they my own madness, or the whispers of another?"<br/>
—Sarkhan Vol]=];
CardNumber="M19164";
Rulings=1;
MultiverseID=447300;
Sets={
{Set="AKH";Rarity="Common";CardNumber="151";Flavor=[=["You are undeserving of the afterlife. You will never feel the God-Pharaoh's embrace."]=];};
};
};
...
Flavor=[=[Though Kefnet's followers feverishly searched his last words for some final riddle, they found only the gurgles of a dying god.]=];
CardNumber="HOU51";
Rulings=1;
MultiverseID=430740;
};
...
MultiverseID=447396;
Sets={
{Set="AER";Rarity="Common";CardNumber="189";Flavor=[=[Beyond the chaos of Ghirapur lies a vibrant world where aether flows through nature.]=];};
{Set="AKH";Rarity="Common";CardNumber="286";Flavor=[=[Beyond the chaos of Ghirapur lies a vibrant world where aether flows through nature.]=];};
};
};
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[Transmogrifying Wand enters the battlefield with three charge counters on it.<br/>
{{1}}, {{Tap}}, Remove a charge counter from Transmogrifying Wand: Destroy target creature. Its controller creates a 2/4 white Ox creature token. Activate this ability only any time you could cast a sorcery.]=];
CardNumber="M19247";
Rulings=2;
MultiverseID=447384;
};
...
MultiverseID=439848;
Sets={
{Set="HOU";Rarity="Common";CardNumber="167";Flavor=[=["Why wander in search of a new home when the path is laid out before you?"
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[When Trial of Ambition enters the battlefield, target opponent sacrifices a creature.<br/>
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[When Trial of Knowledge enters the battlefield, draw three cards, then discard a card.<br/>
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[When Trial of Solidarity enters the battlefield, creatures you control get +2/+1 and gain vigilance until end of turn.<br/>
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[When Trial of Strength enters the battlefield, create a 4/2 green Beast creature token.<br/>
...
Flavor=[=["Pathetic. You might as well have protected your treasures with a paper box and some string."]=];
CardNumber="W1714";
MultiverseID=429903;
};
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[Trueheart Duelist can block an additional creature each combat.<br/>
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[You may exert Trueheart Twins as it attacks. (It won't untap during your next untap step.)<br/>
...
Flavor=[=["Margaret has traveled with me to the end of the world and back."<br/>
—Hewen Frit, merchant]=];
CardNumber="M1941";
Power="2";
Toughness="3";
...
Rarities={"Common"};
Text=[=[Menace (This creature can't be blocked except by two or more creatures.)]=];
Flavor=[=["Thread the torsos together with angel hair to ensure they will cooperate in battle."<br/>
—&lt;i&gt;The Stitcher's Tome&lt;/i&gt;]=];
CardNumber="M19123";
Power="4";
Toughness="2";
MultiverseID=447259;
...
Rarities={"Common"};
Text=[=[Enchant land<br/>
Enchanted land has "{{Tap}}: Add one mana of any color."<br/>
Sacrifice Unbridled Growth: Draw a card.]=];
Flavor=[=["If the Consulate has abandoned restraint, so too shall the wilds."<br/>
...
Rarity="Common";
Rarities={"Common"};
Text=[=[Target player discards two cards.<br/>
Cycling {{2}} ({{2}}, Discard this card: Draw a card.)]=];
Flavor=[=["Ambition requires clarity. If you have any doubts, they must be abandoned."<br/>
—Bontu, god of ambition]=];
CardNumber="AKH114";
Rulings=1;
MultiverseID=426816;
...
Rarity="Common";
Rarities={"Common"};
Text=[=[Creatures your opponents control get -2/-0 until end of turn.<br/>
Draw a card.]=];
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[Target creature gets +3/+3 and gains flying until end of turn.<br/>
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[Whenever an artifact enters the battlefield under your control, you may pay {{1}}. If you do, each opponent loses 1 life and you gain 1 life.<br/>
...
Rarities={"Mythic Rare"};
Text=[=[Flying<br/>
Sphinx spells you cast cost {{2}} less to cast.<br/>
...
Rarity="Common";
Rarities={"Common"};
Text=[=[{{7}}, {{Tap}}, Sacrifice Universal Solvent: Destroy target permanent.]=];
Flavor=[=["A few drops of this, and the trickiest problems simply melt away."<br/>
...
Rarities={"Common"};
Text=[=[Enchant creature<br/>
When Unquenchable Thirst enters the battlefield, if you control a Desert or there is a Desert card in your graveyard, tap enchanted creature.<br/>
Enchanted creature doesn't untap during its controller's untap step.]=];
CardNumber="HOU53";
Rulings=2;
MultiverseID=430742;
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[{{1}}{{W}}: Target attacking Zombie gains lifelink until end of turn.<br/>
{{1}}{{B}}: Target attacking Zombie gains deathtouch until end of turn.]=];
Flavor=[=["We are no longer in control."<br/>
—Elekh, vizier of embalming]=];
CardNumber="HOU147";
Power="2";
Toughness="3";
...
Text=[=[Enchant creature<br/>
Enchanted creature gets +2/+1 and has menace. (It can't be blocked except by two or more creatures.)]=];
Flavor=[=["Mindlessness is not weakness. When we are lost to hunger we are unstoppable."<br/>
...
Rarities={"Uncommon"};
Text=[=[Trample<br/>
Whenever Untethered Express attacks, put a +1/+1 counter on it.<br/>
Crew 1 (Tap any number of creatures you control with total power 1 or more: This Vehicle becomes an artifact creature until end of turn.)]=];
Flavor=[=[Rules and rails are made to be broken.]=];
CardNumber="AER179";
Power="4";
Toughness="4";
Rulings=13;
...
Flavor=[=["Would you rather feel the edge of my blade or the sharpness of my fangs?"]=];
CardNumber="M19304";
Power="2";
Toughness="2";
MultiverseID=450251;
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[Other Knights you control get +1/+1.<br/>
{{3}}{{W}}{{W}}: Knights you control gain double strike until end of turn.]=];
Flavor=[=["Defeat is no reason for retreat. It is a sign we must redouble our efforts to win this fight."]=];
CardNumber="M1942";
Power="3";
Toughness="4";
Rulings=2;
...
Rarity="Common";
Rarities={"Common"};
Text=[=[{{2}}, {{Tap}}: Each opponent loses 1 life and you gain 1 life.]=];
...
Flavor=[=["Your service shall be rewarded."<br/>
—Queen Lian]=];
CardNumber="M19125";
Power="3";
Toughness="4";
...
Flavor=[=["A perfect fusion of nature and artifice."<br/>
—Irsi, Kujar gardener]=];
CardNumber="AER180";
Power="1";
Toughness="2";
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[When Veteran Motorist enters the battlefield, scry 2.<br/>
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[Vile Manifestation gets +1/+0 for each card with cycling in your graveyard.<br/>
Cycling {{2}} ({{2}}, Discard this card: Draw a card.)]=];
...
Rarity="Common";
Rarities={"Common"};
Text=[=[Destroy target artifact or land.<br/>
Cycling {{2}} ({{2}}, Discard this card: Draw a card.)]=];
...
Rarities={"Mythic Rare"};
Text=[=[+2: Put two +1/+1 counters on up to one target creature.<br/>
−3: Target creature you control deals damage equal to its power to target creature you don't control.<br/>
...
Rarity="Mythic Rare";
Rarities={"Mythic Rare"};
Text=[=[+1: Look at the top four cards of your library. You may reveal a creature or land card from among them and put it into your hand. Put the rest on the bottom of your library in a random order.<br/>
−3: Destroy target artifact, enchantment, or creature with flying.<br/>
...
cmc=4;
Colors={"Blue"};
Type="Creature — Shapeshifter Cleric";
Types={"Creature"};
SubTypes={"Shapeshifter";"Cleric";};
Rarity="Rare";
Rarities={"Rare"};
Text=[=[You may have Vizier of Many Faces enter the battlefield as a copy of any creature on the battlefield, except if Vizier of Many Faces was embalmed, the token has no mana cost, it's white, and it's a Zombie in addition to its other types.<br/>
Embalm {{3}}{{U}}{{U}}]=];
CardNumber="AKH74";
Power="0";
Toughness="0";
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[When Vizier of the Anointed enters the battlefield, you may search your library for a creature card with eternalize or embalm, put that card into your graveyard, then shuffle your library.<br/>
...
Rarities={"Mythic Rare"};
Text=[=[You may look at the top card of your library. (You may do this at any time.)<br/>
You may cast the top card of your library if it's a creature card.<br/>
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[You may exert Vizier of the True as it attacks. (It won't untap during your next untap step.)<br/>
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[{{Tap}}: Untap another target permanent.<br/>
Cycling {{1}}{{U}} ({{1}}{{U}}, Discard this card: Draw a card.)<br/>
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[When Voltaic Brawler enters the battlefield, you get {{E}}{{E}} (two energy counters).<br/>
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[Walking Ballista enters the battlefield with X +1/+1 counters on it.<br/>
{{4}}: Put a +1/+1 counter on Walking Ballista.<br/>
...
Rarity="Common";
Rarities={"Common"};
Text=[=[Return up to two target creature cards from your graveyard to your hand.<br/>
Cycling {{2}} ({{2}}, Discard this card: Draw a card.)]=];
...
Flavor=[=[As the Second Sun glided into its final position in the sky, a chorus of wings sounded to herald the return of Nicol Bolas.]=];
CardNumber="HOU206";
Power="2";
Toughness="1";
Rulings=1;
...
Flavor=[=["Before we can destroy our enemies, we must find them. We must peer into every wretched hovel and every teeming market."<br/>
—Baral, Chief of Compliance]=];
CardNumber="AER182";
Power="2";
Toughness="2";
...
MultiverseID=450258;
Sets={
{Set="RIX";Rarity="Common";CardNumber="61";};
};
};
...
Rarities={"Common"};
Text=[=[Menace]=];
Flavor=[=["The giants follow the flow of aether, and twice a year it leads them through here. Lesson learned. More clearance is needed."<br/>
—Sram, senior edificer]=];
CardNumber="KLD139";
Power="4";
Toughness="5";
...
Rarities={"Uncommon"};
Text=[=[Fabricate 2 (When this creature enters the battlefield, put two +1/+1 counters on it or create two 1/1 colorless Servo artifact creature tokens.)]=];
Flavor=[=["No, I don't believe they have the proper permits for those, but I'm not going to be the one to ask."<br/>
...
Flavor=[=["The fires of invention burn in all of us. I fight for the freedom to unleash those flames."<br/>
—Pia Nalaar]=];
CardNumber="KLD140";
Rulings=2;
MultiverseID=417713;
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[When Whirler Virtuoso enters the battlefield, you get {{E}}{{E}}{{E}} (three energy counters).<br/>
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[{{4}}, {{Tap}}: Create a 1/1 colorless Thopter artifact creature token with flying.]=];
Flavor=[=["Our creations are more than mere things. They have life in them, little bits of ourselves."<br/>
—Saheeli Rai]=];
CardNumber="KLD239";
MultiverseID=417812;
};
...
Flavor=[=["I opened my mind to the immensity of the wonders around me. It was only then that I could see the Great Conduit."<br/>
—Rashmi, aether-seer]=];
CardNumber="KLD174";
Rulings=1;
MultiverseID=417747;
...
Types={"Creature"};
SubTypes={"Zombie";"Jackal";"Cleric";};
Rarity="Rare";
Rarities={"Rare"};
Text=[=[Afflict 4 (Whenever this creature becomes blocked, defending player loses 4 life.)<br/>
...
Rarity="Uncommon";
Rarities={"Uncommon"};
Text=[=[If one or more counters would be put on an artifact or creature you control, that many plus one of each of those kinds of counters are put on that permanent instead.<br/>
...
Rarities={"Uncommon"};
Text=[=[Destroy target creature with flying.]=];
Flavor=[=["We are the hands of the great trees, reaching out to ensnare what threatens their branches."<br/>
—Elvish hunter]=];
CardNumber="W1730";
MultiverseID=429919;
};
...
Text=[=[Flying, vigilance<br/>
Cycling {{W}} ({{W}}, Discard this card: Draw a card.)]=];
Flavor=[=["When the Hour of Promise arrives, the God-Pharaoh will tear down the Hekma, for its protection will be needed no longer."<br/>
—The Accounting of Hours]=];
CardNumber="AKH39";
Power="3";
Toughness="3";
...
Rarity="Common";
Rarities={"Common"};
Text=[=[Target creature you control gains indestructible until end of turn. (Damage and effects that say "destroy" don't destroy it. If its toughness is 0 or less, it's still put into its owner's graveyard.)<br/>
Cycling {{2}} ({{2}}, Discard this card: Draw a card.)]=];
CardNumber="HOU81";
MultiverseID=430770;
};
...
SetCode="M19";
Allsets={"M19";"KLD";"AKH";"HOU";"XLN";"RIX";};
Type="Land";
Types={"Land"};
Rarity="Common";
Rarities={"Common";"Uncommon";};
...
MultiverseID=447397;
Sets={
{Set="KLD";Rarity="Common";CardNumber="274";Flavor=[=[Waterways carve their routes through the land to reflect the paths the aether streams cut through the clouds.]=];};
{Set="AKH";Rarity="Common";CardNumber="287";Flavor=[=[Waterways carve their routes through the land to reflect the paths the aether streams cut through the clouds.]=];};
{Set="HOU";Rarity="Common";CardNumber="204";Flavor=[=["Bolas's power on this plane can't be absolute. Look around you."
—Nissa Revane]=];};
...
{Set="RIX";Rarity="Uncommon";CardNumber="191";Flavor=[=[Countless streams flow into the nine rivers, and the nine rivers flow into the Great River. The River Heralds guard them all.]=];};
};
};
...
Rarity="Common";
Rarities={"Common"};
Text=[=[When Woodweaver's Puzzleknot enters the battlefield, you gain 3 life and get {{E}}{{E}}{{E}} (three energy counters).<br/>
...
cmc=2;
Colors={"Black"};
Type="Creature — Zombie Camel";
Types={"Creature"};
SubTypes={"Zombie";"Camel";};
Rarity="Common";
Rarities={"Common"};
...
Rarities={"Rare"};
Text=[=[Haste<br/>
Whenever a creature an opponent controls dies, put a +1/+1 counter on Yahenni, Undying Partisan.<br/>
...
Rarity="Rare";
Rarities={"Rare"};
Text=[=[All creatures get -3/-3 until end of turn.<br/>
You may cast a card with converted mana cost 3 or less from your hand without paying its mana cost.]=];
